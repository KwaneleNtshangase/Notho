...
docs/archive/prompts/HANDOFF-NEXT-CHAT.md docs/guides/DEPLOY-LESSON-BANKS.md
```
...
docs/MONITORING.md
docs/guides/NOTHO-CONTEXT-BRIEF.md, docs/guides/NOTHO_Content_Production_Guide.md,
docs/guides/NOTHO_Marketing_Content_Playbook.md
```
