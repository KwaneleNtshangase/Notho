...
recipe are in **`docs/archive/prompts/HANDOFF-NEXT-CHAT.md`** — read that before touching content.
...
docs/archive/prompts/HANDOFF-NEXT-CHAT.md    archived lesson-bank work stream
```
