...
export function CalculatorView() {
  ...
  const drawing = (calcA.withdrawalMode ?? "rand") === "percent" ? (calcA.withdrawalPercent ?? 0) > 0 : (calcA.withdrawal ?? 0) > 0;
  const showWithdrawals = drawing && ((calcA.withdrawFromYear ?? calcA.years) < calcA.years || calcA.wrapper === "living-annuity");
