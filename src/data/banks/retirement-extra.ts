...
const raSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "rtx-rp-ct-mcq", step: { type: "mcq", question: "What's the main advantage of a retirement annuity over a workplace pension fund?", options: ["You control provider and fees", "It's exempt from Regulation 28", "It has no fees at all", "Withdrawals are allowed anytime"], correct: 0, feedback: { correct: "Right. An RA follows you between jobs and you choose what's inside it, but both are bound by Regulation 28 and the same access rules.", incorrect: "Control is the difference. Both sit under Reg 28 and neither allows early access outside the two-pot savings component." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "rtx-rp-dl-mcq", step: { type: "mcq", question: "How does the deduction limit apply when you contribute to both a pension fund and an RA?", options: ["One combined 27.5% limit", "Each fund gets its own 27.5%", "Only the RA is deductible", "Only the pension is deductible"], correct: 0, feedback: { correct: "Right. Employer and employee contributions across all funds are added together against one limit.", incorrect: "It's a single combined limit across all retirement funds, not one per fund." } } },
  ...
  },
  {
    ...
    variants: [
      { variantId: "rtx-rp-tp-mcq", step: { type: "mcq", question: "How does the two-pot system split new retirement contributions?", options: ["A third accessible", "Half and half between the two", "All of it accessible", "All locked until age 55"], correct: 0, feedback: { correct: "Right, and the Retirement component must be used for an annuity at retirement. That's the part designed to actually last.", incorrect: "One third savings, two thirds retirement. The larger portion stays locked deliberately." } } },
      ...
      { variantId: "rtx-rp-tp-sc", step: { type: "scenario", question: "Sipho wants to withdraw from his savings pot to fund a holiday. What should he weigh?", options: ["Tax plus the income forgone", "Only the administration fee", "Nothing, it's meant for this", "Whether his employer approves"], correct: 0, feedback: { correct: "Right. Accessible isn't the same as free: at a 31% rate, R20 000 withdrawn is about R13 800 in hand and a permanent hole in the fund.", incorrect: "Tax plus lost growth. Accessibility was designed for genuine emergencies, not discretionary spending." } } },
    ],
  },
];
...
const ageSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "rtx-ag-wc-sc", step: { type: "scenario", question: "Johan wants to retire at 55 instead of 65. What are his realistic levers?", options: ["Save more, or work part-time", "Choose riskier investments to catch up", "Rely on the state old age grant", "Withdraw from his savings pot yearly"], correct: 0, feedback: { correct: "Right. Contribution rate, spending target and semi-retirement are the three honest levers, extra risk isn't a plan.", incorrect: "Save more, spend less, or work part-time. Taking more risk to fund an earlier date increases the chance of failure." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { variantId: "rtx-ag-tn-mcq", step: { type: "mcq", question: "What's the most useful starting point for a retirement target?", options: ["Your expected expenses", "Your current salary times ten", "A round number like R5 million", "Whatever your colleagues aim for"], correct: 0, feedback: { correct: "Right. Expenses drive the number, and they're usually lower than your salary once the bond and the children are done.", incorrect: "Start with expenses. Salary includes contributions and costs that stop at retirement." } } },
  ...
  },
  {
    ...
    variants: [
      { variantId: "rtx-ag-sq-mcq", step: { type: "mcq", question: "What is sequence of returns risk?", options: ["Poor returns early on", "The risk of outliving your money", "The risk of inflation", "Choosing the wrong annuity"], correct: 0, feedback: { correct: "Right. The same average return in a different order can produce a very different outcome once you're withdrawing.", incorrect: "It's about the order of returns. Early losses combined with withdrawals do damage that later gains can't undo." } } },
...
const annSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "rtx-an-lr-mcq", step: { type: "mcq", question: "Which type of annuity removes the risk of outliving your money?", options: ["A guaranteed annuity", "A living annuity", "A unit trust", "A bank fixed deposit"], correct: 0, feedback: { correct: "Right. The insurer takes the longevity risk. The trade-off is that you give up the capital and the flexibility.", incorrect: "A guaranteed life annuity. A living annuity leaves the longevity risk with you." } } },
  ...
  },
  {
    ...
    conceptId: "annuity-types",
    variants: [
      { variantId: "rtx-an-la-mcq", step: { type: "mcq", question: "What are the defining features of a living annuity?", options: ["You pick investments and drawdown", "The insurer guarantees income for life", "It pays a fixed amount out forever", "It can never be inherited by anyone"], correct: 0, feedback: { correct: "Right. Flexibility and inheritability are the advantages; investment and longevity risk are the price.", incorrect: "It's investor-controlled with a regulated drawdown range, and the remaining capital passes to your beneficiaries." } } },
      ...
      { variantId: "rtx-an-la-sc", step: { type: "scenario", question: "Sipho retires with R4 million in a living annuity. What drawdown gives the income the best chance of lasting?", options: ["Near the lower end, 4 to 5%", "The maximum 17.5% allowed", "Whatever covers his lifestyle", "0%, drawing nothing at all"], correct: 0, feedback: { correct: "Right. Around R160 000–R200 000 a year gives the capital a realistic chance of keeping pace with inflation.", incorrect: "A conservative rate near the bottom of the range. High early drawdowns are what deplete living annuities." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "rtx-an-ir-sc", step: { type: "scenario", question: "Priya is offered a level annuity paying more now, or an escalating one paying less. What should she weigh?", options: ["Longevity and inflation", "Only the starting amount", "Which provider looks nicer", "Whether her friends chose it"], correct: 0, feedback: { correct: "Right. The level annuity wins for the first several years and loses badly after that if she lives a long life.", incorrect: "Longevity and inflation. A higher starting income is worth less than it looks over a 25-year retirement." } } },
    ],
  },
];
...
const healthSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "rtx-hc-mi-mcq", step: { type: "mcq", question: "How does medical inflation in SA typically compare with general inflation?", options: ["Consistently higher", "About the same as it", "Consistently lower", "It varies randomly"], correct: 0, feedback: { correct: "Right, and it compounds, which is why a retirement plan built on general inflation understates healthcare costs badly.", incorrect: "Medical inflation runs above CPI year after year, so healthcare takes a growing share of a retiree's budget." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "rtx-hc-kc-mcq", step: { type: "mcq", question: "What's the risk of cancelling medical scheme cover and rejoining years later?", options: ["A late-joiner penalty", "Nothing, you can rejoin freely", "A one-month waiting period only", "You'd need a medical examination"], correct: 0, feedback: { correct: "Right. Late-joiner penalties are calculated on years without cover and stay on the premium indefinitely.", incorrect: "Waiting periods plus a permanent late-joiner penalty based on how long you were uncovered." } } },
      { variantId: "rtx-hc-kc-sc", step: { type: "scenario", question: "Nomsa's premium is squeezing her budget in retirement. What's the better move than cancelling?", options: ["Downgrade but keep cover", "Cancel and self-fund it", "Cancel and rejoin when sick", "Keep it and cut food spending"], correct: 0, feedback: { correct: "Right. Continuous membership protects her from penalties, and every registered option must still cover PMBs.", incorrect: "Downgrade rather than cancel. Continuous cover is what preserves her position." } } },
    ],
  },
  {
    ...
    conceptId: "retirement-healthcare",
    variants: [
      { variantId: "rtx-hc-gp-mcq", step: { type: "mcq", question: "Why does gap cover matter more in retirement?", options: ["Shortfalls above tariff grow", "Gap cover is cheaper for pensioners", "It replaces medical aid", "It covers all of your medication"], correct: 0, feedback: { correct: "Right. A single procedure charged well above scheme rates can produce a shortfall a retiree can't absorb.", incorrect: "The frequency of specialist care rises with age, and so does the shortfall risk it creates." } } },
      ...
      { variantId: "rtx-hc-gp-sc", step: { type: "scenario", question: "Sipho is comparing retirement medical options on a fixed income. What matters most?", options: ["Chronic and hospital cover", "The lowest possible premium", "Gym benefits and rewards points", "The scheme's advertising"], correct: 0, feedback: { correct: "Right. On a fixed income, an unfunded shortfall is far more dangerous than a slightly higher premium.", incorrect: "Chronic cover, hospital cover and shortfall exposure. The cheapest premium can be the most expensive choice." } } },
    ],
  },
  {
    ...
    conceptId: "retirement-healthcare",
    variants: [
      { variantId: "rtx-hc-fc-mcq", step: { type: "mcq", question: "Which late-life cost is most often left out of retirement plans?", options: ["Frail care", "Medical aid premiums", "Groceries", "Transport costs"], correct: 0, feedback: { correct: "Right. Frail care can cost more than a household's entire monthly budget, and schemes cover very little of it.", incorrect: "Frail care and assisted living. They're expensive, common in late life, and largely outside scheme cover." } } },
...
const estSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "rtx-es-fn-sc", step: { type: "scenario", question: "Johan's nomination form is fifteen years old and names an ex-spouse. What's the risk?", options: ["It misleads the trustees", "It's automatically invalid", "The will overrides it", "Nothing, trustees ignore it"], correct: 0, feedback: { correct: "Right. Trustees weigh the nomination alongside actual dependency: an outdated form muddies exactly the evidence they rely on.", incorrect: "An outdated form creates confusion and delay. Update it whenever your circumstances change." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "rtx-es-ld-mcq", step: { type: "mcq", question: "What happens to a guaranteed life annuity when the annuitant dies?", options: ["Payments generally stop", "The capital passes to the estate", "Beneficiaries keep receiving it", "The insurer refunds all premiums"], correct: 0, feedback: { correct: "Right, which is exactly the trade for lifetime certainty. A guarantee term or joint-life option changes it, at a cost.", incorrect: "Payments generally cease. That's the price of the lifetime guarantee, unless you paid for a guarantee period." } } },
  ...
  },
  {
    ...
    variants: [
      { variantId: "rtx-es-lq-mcq", step: { type: "mcq", question: "Why does an estate need liquidity?", options: ["Costs must be paid first", "To pay beneficiaries interest", "To cover funeral costs only", "Estates don't need any cash"], correct: 0, feedback: { correct: "Right. Without cash, the executor may have to sell the family home to settle costs, which is rarely what anyone intended.", incorrect: "Costs must be settled before distribution. An illiquid estate forces asset sales at whatever price is available." } } },
      ...
      { variantId: "rtx-es-lq-sc", step: { type: "scenario", question: "Sipho's estate is mostly a paid-off house and a living annuity. What's the liquidity risk?", options: ["The house may have to be sold", "There is no real risk at all", "The annuity pays the costs", "SARS covers the shortfall"], correct: 0, feedback: { correct: "Right. The annuity passes outside the estate, so it isn't available for estate costs. A life policy is the usual fix.", incorrect: "The house may have to be sold. Assets that bypass the estate can't fund the estate's costs." } } },
    ],
  },
  {
    ...
    conceptId: "beneficiary-nominations",
    variants: [
      { variantId: "rtx-es-kc-mcq", step: { type: "mcq", question: "Which documents should be reviewed after a major life change?", options: ["Will, nominations and policies", "Only your will", "Only your fund nomination", "None, they update automatically"], correct: 0, feedback: { correct: "Right, and they're separate documents. Updating a will does nothing to a nomination form held by a fund or insurer.", incorrect: "All of them. Each is held separately, and a will doesn't override a nomination on a fund or policy." } } },
      ...
      { variantId: "rtx-es-kc-sc", step: { type: "scenario", question: "Priya remarries at 62. What should she do?", options: ["Update her will and nominations", "Only update her will", "Wait until retirement to review", "Assume marriage overrides them"], correct: 0, feedback: { correct: "Right, and a shared document register naming where everything is held makes this far easier for her family later.", incorrect: "Update everything. Marriage doesn't automatically revoke or amend existing nominations." } } },
    ],
  },
];
