...
const saveSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "savings-account-rates",
    variants: [
      { variantId: "bdx-sv-nc-mcq", step: { type: "mcq", question: "What does a 32-day notice account trade for its higher interest rate?", options: ["Instant access to the money", "Deposit insurance protection", "The ability to earn interest", "Access for anyone under 25"], correct: 0, feedback: { correct: "Right. It's a liquidity trade: less access, better rate. Suits money you're unlikely to need this month.", incorrect: "You give up instant access. Notice accounts pay more precisely because your money is less available." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-sv-it-mcq", step: { type: "mcq", question: "Which account lets interest, dividends and growth accumulate with no SA tax at all?", options: ["A tax-free savings account", "A 32-day notice savings account", "A money market unit trust fund", "A five-year bank fixed deposit"], correct: 0, feedback: { correct: "Right. The TFSA has no tax on interest, dividends or capital gains, but contributions are capped at R46 000 a year and R500 000 for life.", incorrect: "Only the TFSA. The others all fall under the ordinary interest exemption and then normal tax." } } },
      { variantId: "bdx-sv-it-sc", step: { type: "scenario", question: "Johan is 40 and earns R30 000 of local interest this year. What's the tax position?", options: ["R23 800 is exempt", "All R30 000 is exempt", "All R30 000 is taxed", "Interest is taxed at a flat 15%"], correct: 0, feedback: { correct: "Right. Only the excess above the exemption is taxable, at whatever bracket he sits in.", incorrect: "The first R23 800 is exempt under 65. Only R6 200 is taxable, at his marginal rate." } } },
    ],
  },
  {
    ...
    variants: [
      { variantId: "bdx-sv-we-sc", step: { type: "scenario", question: "You hold R80 000 in a call account at 6.5%. A money market fund pays 9.2% with access in one to two days. Extra interest a year?", options: ["About R2 160", "About R800", "About R5 000", "Nothing"], correct: 0, feedback: { correct: "R80 000 × 2.7% = R2 160 for essentially the same accessibility. Worth the paperwork.", incorrect: "9.2% − 6.5% = 2.7%. R80 000 × 2.7% = R2 160 more a year." } } },
...
const cardSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-cd-pr-mcq", step: { type: "mcq", question: "You pay a R12 000 deposit online and the supplier disappears. Which payment method gives you the best recourse?", options: ["A credit card chargeback", "A debit card payment", "An instant EFT", "A cash deposit at a branch"], correct: 0, feedback: { correct: "Right. A chargeback reverses the transaction through the card scheme. EFT and cash have no equivalent protection.", incorrect: "Credit card chargebacks are the strongest recourse. EFT and cash are effectively irreversible." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-cd-ic-mcq", step: { type: "mcq", question: "Why do minimum payments keep a card balance alive for years?", options: ["Most of the payment goes to interest", "Banks refuse larger payments", "Interest is waived first", "Interest only starts after 12 months"], correct: 0, feedback: { correct: "Right. On a R20 000 balance the interest alone is around R342 a month, so a small minimum leaves almost nothing for capital.", incorrect: "The minimum is mostly interest. Very little touches the capital, which is why the balance persists." } } },
...
const switchSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-sw-os-sc", step: { type: "scenario", question: "Sipho closed his old account a week after opening the new one. What's the likely consequence?", options: ["Unmigrated debit orders bounce", "Nothing, banks handle it", "His salary arrives twice", "His credit score improves"], correct: 0, feedback: { correct: "Right. Bounced debit orders attract fees from both the bank and the service provider, and missed payments can reach your credit record.", incorrect: "Debit orders don't move automatically. Anything still pointing at the closed account will bounce." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-sw-ne-mcq", step: { type: "mcq", question: "When should you give payroll your new banking details?", options: ["Before the payroll cut-off", "After the salary has bounced", "At the end of the tax year", "Only once the old one is closed"], correct: 0, feedback: { correct: "Right. Payroll cut-offs are usually mid-month, and a salary sent to a closed account can take weeks to recover.", incorrect: "Before the cut-off, in writing. Recovering a misdirected salary is slow and painful." } } },
  ...
  },
  {
    ...
    conceptId: "bank-switching",
    variants: [
      { variantId: "bdx-sw-op-mcq", step: { type: "mcq", question: "How long should you keep the old account open after switching?", options: ["About two months", "Only a single day", "About one week only", "At least a full year"], correct: 0, feedback: { correct: "Right. Two months covers two full billing cycles, which is when stragglers show up.", incorrect: "Around two months. Debit orders take one to two billing cycles to fully migrate." } } },
...
const odSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "overdraft",
    variants: [
      { variantId: "bdx-od-ws-mcq", step: { type: "mcq", question: "You dip into your R5 000 overdraft from the 20th of every month until payday. What does that pattern mean?", options: ["Expenses exceed income monthly", "You're managing cash flow well", "Your overdraft limit is too low", "Nothing, everyone does this"], correct: 0, feedback: { correct: "Right. A permanent overdraft is a structural budget gap wearing a credit costume. A bigger limit just makes it more expensive.", incorrect: "It's a budget deficit, not a cash-flow technique. The fix is in the budget, not the credit limit." } } },
      ...
      { variantId: "bdx-od-ws-sc", step: { type: "scenario", question: "Nomsa's overdraft is R8 000 deep every month and the bank offers to raise the limit to R15 000. Best response?", options: ["Decline, and fix the budget gap", "Accept, more headroom is safer", "Accept and use it as an emergency fund", "Accept and switch to a credit card"], correct: 0, feedback: { correct: "Right. A larger limit deepens the hole rather than closing it. Find the R8 000 gap in the budget instead.", incorrect: "A bigger limit doesn't fix a deficit, it funds it: at 18–22% interest." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-od-co-mcq", step: { type: "mcq", question: "How does overdraft interest accrue?", options: ["Daily, on the outstanding balance", "Monthly, on the opening balance", "Annually, at the year-end", "Only after a full month overdrawn"], correct: 0, feedback: { correct: "Right. Daily accrual means even a few days in overdraft each month adds up quietly over a year.", incorrect: "It's daily. That's why short, repeated dips still cost real money." } } },
  ...
  },
  {
    ...
    conceptId: "overdraft",
    variants: [
      { variantId: "bdx-od-ff-mcq", step: { type: "mcq", question: "Besides interest, what else does an overdraft usually cost?", options: ["A facility fee, used or not", "Nothing, interest is the only charge", "A charge only when you repay it", "A fee paid by the merchant"], correct: 0, feedback: { correct: "Right. Many facilities carry a service or availability fee even at a zero balance, so an unused overdraft still costs you.", incorrect: "Facility fees are common and often charged whether you draw on it or not." } } },
  ...
  },
  {
    ...
    conceptId: "overdraft",
    variants: [
      { variantId: "bdx-od-lu-mcq", step: { type: "mcq", question: "Which is a defensible short-term use of an overdraft?", options: ["A one-off emergency before payday", "Funding your normal monthly shortfall", "Paying for a family holiday abroad", "Topping up a regular savings account"], correct: 0, feedback: { correct: "Right. Brief, one-off, and cleared immediately. Anything recurring is a budget problem wearing a different label.", incorrect: "One-off and short is defensible. Recurring use, holidays and 'saving' with borrowed money are not." } } },
...
const fxSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "bdx-fx-hm-mcq", step: { type: "mcq", question: "Where does most of the cost of a bank's foreign exchange service hide?", options: ["In the exchange rate margin", "In the transfer fee, always disclosed", "In SARS taxes on the transfer", "In the recipient bank's charges"], correct: 0, feedback: { correct: "Right. A 3% margin on R10 000 is R300 you never see itemised, usually more than the visible fee.", incorrect: "The margin on the exchange rate is the real cost. The flat fee is often the smaller half." } } },
      ...
      { variantId: "bdx-fx-hm-sc", step: { type: "scenario", question: "You want to compare two providers honestly. What should you compare?", options: ["How much actually lands with them", "The advertised transfer fee alone", "Which one has the nicer app", "The mid-market rate that day"], correct: 0, feedback: { correct: "Right. The amount received is the only number that includes both the fee and the rate margin.", incorrect: "Compare the amount received. Fees and rate margins only matter through their effect on that number." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-fx-ca-sc", step: { type: "scenario", question: "Priya is going to Thailand for two weeks. What's the sensible setup?", options: ["A travel card plus some local cash", "All her spending money in rand cash", "One high-fee bank card only", "Exchange everything at the airport"], correct: 0, feedback: { correct: "Right. The card handles most spending near mid-market rates, and a little cash covers the taxi before she finds an ATM.", incorrect: "Card first, small cash buffer second. Airport exchange and rand cash are the expensive options." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "bdx-fx-cp-mcq", step: { type: "mcq", question: "How often should you compare providers for international transfers?", options: ["Every time, margins differ", "Once, then stay loyal", "Only for amounts over R1 million", "Never, they're all priced the same"], correct: 0, feedback: { correct: "Right. Pricing varies by destination and by amount, so the best option for the UK may not be best for Kenya.", incorrect: "Every time. There's no fixed pricing, and the gap on a large transfer can be thousands of rands." } } },
    ],
  },
];
