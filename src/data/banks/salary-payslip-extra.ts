...
const bonusSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-bo-pc-sc", step: { type: "scenario", question: "Sipho wants his R20 000 bonus to still exist in March. Best move on the day it's announced?", options: ["Write the split down and set the transfers for payday", "Keep it in his current account and decide later", "Tell nobody and see what's left in March", "Spend the fun portion first, save whatever survives"], correct: 0, feedback: { correct: "Right. Automating the transfers on payday means the money is gone before it can be casually spent.", incorrect: "Write the split down and automate it. Money left sitting in a current account gets absorbed by ordinary spending." } } },
    ],
  },
  {
    ...
    conceptId: "bonus-planning",
    variants: [
      { variantId: "spx-bo-df-sc", step: { type: "scenario", question: "Lerato gets R30 000. She has R45 000 on a credit card at 20% and no emergency fund. Strongest use?", options: ["R20 000 off the card, R10 000 into an emergency fund", "Split it evenly across holiday, debt and savings", "Put all R30 000 into an ETF", "Keep it in her cheque account as a buffer"], correct: 0, feedback: { correct: "Clearing 20% debt is a guaranteed 20% return. R20 000 off the card saves about R4 000 a year. The R10 000 buffer stops the next crisis going back on the card.", incorrect: "Kill the 20% debt first: no investment guarantees 20%. Then build a small buffer so the card doesn't get used again." } } },
      { variantId: "spx-bo-df-mcq", step: { type: "mcq", question: "Why does paying off a 20% credit card usually beat investing the same money?", options: ["The 20% saving is guaranteed; investment returns aren't", "Credit card debt can't be paid off any other way", "SARS gives a rebate for settling card debt", "Investments are taxed at 20% too"], correct: 0, feedback: { correct: "Right. Wiping a 20% debt is a risk-free 20% return, markets can't promise that.", incorrect: "It's the certainty. Clearing 20% interest is a guaranteed 20%, while investment returns are a hope, not a promise." } } },
...
const ctcSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "ctc-structure",
    variants: [
      { variantId: "spx-ct-cp-mcq", step: { type: "mcq", question: "Which of these sits inside a typical CTC figure but never appears as a deduction on your payslip?", options: ["The employer's SDL contribution", "Your PAYE", "Your UIF contribution", "Your medical aid contribution"], correct: 0, feedback: { correct: "Right. SDL is 1% of payroll paid by the employer to SARS, it funds SETA training and is never deducted from you.", incorrect: "SDL is employer-only. PAYE, UIF and medical aid all come off your side of the payslip." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-ct-sd-sc", step: { type: "scenario", question: "Johan compares two R480 000 CTC offers. Job A is mostly basic salary; Job B has a lower basic with generous employer medical aid and pension. What should he do?", options: ["Ask for a full breakdown and compare net pay plus benefit value", "Take Job A. More cash is always better", "Take Job B. Benefits always beat cash", "Flip a coin; identical CTC means identical outcome"], correct: 0, feedback: { correct: "Right. Group medical rates and pre-tax retirement contributions often make Job B worth more, but only the breakdown tells you.", incorrect: "Neither wins automatically. Get both breakdowns. Net pay and benefit value together decide it." } } },
      { variantId: "spx-ct-sd-mcq", step: { type: "mcq", question: "The single most useful question to ask a recruiter about a CTC offer is:", options: ["What is the estimated monthly net pay and full package breakdown?", "How many people applied?", "When is the annual increase cycle?", "Does the company have a gym?"], correct: 0, feedback: { correct: "Right. The breakdown turns an abstract CTC number into something you can actually budget against.", incorrect: "Ask for the net-pay estimate and the breakdown. That's the only way to compare offers honestly." } } },
    ],
  },
  {
    ...
    conceptId: "sdl",
    variants: [
      { variantId: "spx-ct-sl-mcq", step: { type: "mcq", question: "The Skills Development Levy is:", options: ["1% of payroll, paid by the employer to SARS", "1% of your salary, deducted from your pay", "A voluntary training contribution", "A SARS penalty on late payroll"], correct: 0, feedback: { correct: "Right. It's an employer cost funding SETA learnerships and bursaries: you benefit through employer-funded training.", incorrect: "SDL is 1% of payroll and employer-paid. If it ever appears as a deduction on your payslip, query it." } } },
...
const filingSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "spx-fi-wf-mcq", step: { type: "mcq", question: "Which of these makes filing a return compulsory for a salaried employee?", options: ["Freelance income of R45 000 on top of your salary", "Having one employer for the full tax year", "Receiving a correct SARS auto-assessment", "Belonging to a medical aid"], correct: 0, feedback: { correct: "Right. Non-salary income above R30 000 also puts you into provisional tax territory, so it must be declared.", incorrect: "Extra income is the trigger. One salary with correct PAYE and an accurate auto-assessment usually needs no return." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-fi-aa-sc", step: { type: "scenario", question: "Your auto-assessment ignores the R30 000 you paid into a private RA. What now?", options: ["Reject the auto-assessment and file a return claiming the RA deduction", "Accept it, you can't change an auto-assessment", "Claim it next year instead", "Ask your employer to fix it on the IRP5"], correct: 0, feedback: { correct: "Right. A private RA doesn't appear on your IRP5, so you file to claim it: at a 31% rate that R30 000 is worth about R9 300.", incorrect: "You can reject an auto-assessment and file. Claiming a private RA contribution is exactly why you'd do that." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-fi-lp-mcq", step: { type: "mcq", question: "You've missed the filing deadline and owe R8 000. What limits the damage?", options: ["File immediately, then arrange payment terms with SARS", "Wait until you can pay the full R8 000", "Skip this year and file two returns next year", "Dispute the amount to pause the penalties"], correct: 0, feedback: { correct: "Right. The monthly admin penalty keeps running until the return is in, so filing stops the bleeding.", incorrect: "File first. The penalty clock is tied to the outstanding return, not the outstanding payment." } } },
    ],
  },
  {
    ...
    variants: [
      { variantId: "spx-fi-tl-sc", step: { type: "scenario", question: "You receive a R3 000/month travel allowance but kept no logbook. At assessment, SARS:", options: ["Includes 80% of the allowance in your taxable income", "Treats the whole allowance as tax-free", "Includes exactly half of it", "Ignores allowances under R5 000/month"], correct: 0, feedback: { correct: "Right. No logbook means no proof of business travel, so 80% is taxed. A compliant logbook can claw much of that back.", incorrect: "Without a logbook, 80% of the allowance is included in taxable income. The logbook is what proves business use." } } },
      { variantId: "spx-fi-tl-mcq", step: { type: "mcq", question: "A SARS-compliant travel logbook must record:", options: ["Date, opening and closing kilometres, destination and business purpose", "Only the total kilometres for the year", "Fuel slips and nothing else", "Just the trips over 50km"], correct: 0, feedback: { correct: "Right. Without those four elements SARS can reject the claim entirely, even if you really did travel.", incorrect: "Date, kilometres, destination and business reason, all four, per trip. Fuel slips alone prove nothing." } } },
...
const structSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-st-ae-mcq", step: { type: "mcq", question: "Which of these is tax evasion rather than legitimate planning?", options: ["Not declaring R80 000 of freelance income", "Claiming a valid RA deduction", "Contributing to a TFSA", "Claiming home-office costs you genuinely incurred"], correct: 0, feedback: { correct: "Right. Concealing income is a criminal offence. The other three are allowances SARS explicitly provides.", incorrect: "Hiding income is evasion. RAs, TFSAs and genuine home-office claims are all lawful." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-st-rl-sc", step: { type: "scenario", question: "Johan earns R960 000 a year and contributes R240 000 to his RA. Is that fully deductible?", options: ["Yes. R240 000 is under both 27.5% and the R430 000 cap", "No. It exceeds the annual rand cap", "No. RA contributions are capped at R10 000 a month", "Only 15% of it is deductible"], correct: 0, feedback: { correct: "R960 000 × 27.5% = R264 000, and R240 000 sits under that and under R430 000. Full deduction, taxable income down to R720 000.", incorrect: "27.5% of R960 000 is R264 000, and the cap is R430 000. His R240 000 clears both tests." } } },
    ],
  },
  {
    ...
    conceptId: "ctc-structure",
    variants: [
      { variantId: "spx-st-eb-mcq", step: { type: "mcq", question: "Why can employer-paid medical aid beat the same value paid as cash?", options: ["Group scheme rates are cheaper than what you'd pay individually", "Medical aid is completely untaxed", "Cash salary is taxed at 45% for everyone", "Employers refund the premium at year-end"], correct: 0, feedback: { correct: "Right. Group pricing plus the medical scheme fees tax credit usually beats buying the same cover yourself.", incorrect: "The advantage is group pricing and the tax credit. The benefit itself is still a taxable fringe benefit." } } },
      ...
      { variantId: "spx-st-eb-sc", step: { type: "scenario", question: "You want a lower PAYE bill legally. Which lever is available to most salaried employees?", options: ["Increasing your retirement-fund contribution up to the 27.5% limit", "Asking to be paid in cash", "Registering as a company and invoicing your employer", "Declaring fewer months of income"], correct: 0, feedback: { correct: "Right. It's the cleanest legal lever: it lowers taxable income now and builds retirement savings at the same time.", incorrect: "The retirement-fund deduction is the reliable, legal option. The others range from useless to criminal." } } },
    ],
  },
];
...
const errorSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "spx-er-rf-mcq", step: { type: "mcq", question: "Your payslip deducts R1 500 for medical aid but HR confirmed R1 100. What now?", options: ["Email payroll with the evidence and ask for a correction and refund", "Accept it. Payroll systems rarely get things wrong", "Wait a month to see if it corrects itself", "Ask your bank to reverse the deduction"], correct: 0, feedback: { correct: "Right. Written queries create a record, and overdeductions are normally corrected in the next pay cycle.", incorrect: "Raise it in writing straight away. Silence makes the error look accepted and harder to reverse later." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-er-bd-mcq", step: { type: "mcq", question: "Your employer deducts R2 000 for a broken company laptop without asking you. Where do you take it?", options: ["The CCMA or the Department of Employment and Labour", "The National Financial Ombud", "SARS", "The National Credit Regulator"], correct: 0, feedback: { correct: "Right. Unauthorised salary deductions are an employment matter, the CCMA and Labour handle them, not financial ombuds.", incorrect: "This is an employment law issue. The CCMA or Department of Employment and Labour is the right forum." } } },
      { variantId: "spx-er-bd-sc", step: { type: "scenario", question: "Sipho is asked to sign a blanket consent allowing 'any deduction the company deems necessary'. Sensible response?", options: ["Ask for the deduction to be specific in amount and reason before signing", "Sign it. Refusing looks difficult", "Sign it and dispute deductions later", "Resign"], correct: 0, feedback: { correct: "Right. Consent should be specific. An open-ended authorisation hands over control of your pay.", incorrect: "Push for specifics. A blanket consent is exactly what the BCEA's protection is designed to prevent." } } },
    ],
  },
  {
...
const medSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-md-cd-sc", step: { type: "scenario", question: "Your payslip shows the medical tax credit already applied. What does that mean for your monthly PAYE?", options: ["Your PAYE is already reduced by the credit each month", "You'll only get the benefit as a refund in July", "You must claim it separately on eFiling", "It only counts if you file a return"], correct: 0, feedback: { correct: "Right. Employers apply it in the monthly PAYE calculation, so the benefit reaches you every payday.", incorrect: "It's applied monthly through payroll: you don't wait for assessment to get it." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-md-pc-sc", step: { type: "scenario", question: "Priya compares a R1 800 hospital plan with a R4 200 comprehensive plan. She sees a GP four times a year at R700 and spends R500/month on chronic medication. What's the honest comparison?", options: ["She saves R28 800 in premiums but pays about R8 800 out of pocket. Roughly R20 000 ahead if she has the cash", "The hospital plan costs her more overall", "The two options work out the same", "The comprehensive plan is always safer regardless of cost"], correct: 0, feedback: { correct: "GP R2 800 + medication R6 000 = R8 800 against a R28 800 premium saving. The catch is needing that R8 800 available when it's needed.", incorrect: "Premium saving R28 800, out-of-pocket R8 800, so about R20 000 ahead. Provided she can fund the day-to-day costs." } } },
      { variantId: "spx-md-pc-mcq", step: { type: "mcq", question: "The main risk of downgrading to a hospital plan is that:", options: ["Day-to-day costs come straight out of your pocket", "Hospital plans exclude emergencies", "You lose the medical tax credit", "You can never upgrade again"], correct: 0, feedback: { correct: "Right. The saving is real, but only if the day-to-day money is actually set aside rather than spent.", incorrect: "The credit continues and emergencies are covered. The risk is unfunded day-to-day costs." } } },
    ],
  },
];
...
const decodeSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "spx-dc-np-mcq", step: { type: "mcq", question: "On a payslip, 'net pay' means:", options: ["Gross pay less every employee deduction", "Gross pay less PAYE only", "Your CTC divided by twelve", "Gross pay less employer contributions"], correct: 0, feedback: { correct: "Right. PAYE, UIF, pension and medical aid all come off before the amount that reaches your bank.", incorrect: "Net is gross minus all employee deductions, not just PAYE." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "spx-dc-sd-sc", step: { type: "scenario", question: "A friend calculates his net pay by subtracting every line on the payslip, including the employer pension and SDL. What's wrong?", options: ["He's double-counting employer costs", "Nothing. That's the correct method", "He's forgotten to add UIF back", "He should also subtract his gross"], correct: 0, feedback: { correct: "Right. Employer contributions are the company's cost. Only the employee column reduces what reaches his account.", incorrect: "He's subtracting the employer's costs from his own pay. Only employee deductions count." } } },
    ],
  },
  {
    ...
    conceptId: "uif",
    variants: [
      { variantId: "spx-dc-uc-mcq", step: { type: "mcq", question: "Sipho earns R25 000 and his UIF line shows R177.12. Why isn't it R250?", options: ["UIF is 1% of earnings up to a R17 712 monthly ceiling", "UIF is calculated on net pay", "His employer is underpaying UIF", "UIF is 0.7% for salaried employees"], correct: 0, feedback: { correct: "Right. 1% of the R17 712 ceiling is R177.12, and that's the maximum either he or his employer pays.", incorrect: "There's an earnings ceiling of R17 712. Above it, the 1% stops growing at R177.12." } } },
