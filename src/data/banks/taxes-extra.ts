...
const certSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "txx-ct-wt-sc", step: { type: "scenario", question: "Ayesha changed jobs mid-year. How many IRP5s should she expect?", options: ["One from each employer, both of which must appear on her return", "One combined certificate from SARS", "Only one, from her current employer", "None, SARS handles it automatically"], correct: 0, feedback: { correct: "Right. Missing the first employer's certificate is a common cause of an under-declared return and a later SARS query.", incorrect: "One per employer. Both must be reflected, or her income is understated." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "tax-certificates",
    variants: [
      { variantId: "txx-ct-cp-sc", step: { type: "scenario", question: "Priya's IRP5 shows R68 000 of PAYE under code 4102, but her payslips add up to R60 000. What does that suggest?", options: ["An error somewhere. She should query it with payroll before filing", "SARS added interest", "Her employer paid extra tax as a benefit", "Nothing: the figures never match exactly"], correct: 0, feedback: { correct: "Right. SARS assesses against the IRP5, so an R8 000 discrepancy must be resolved with payroll first. A corrected IRP5 is the fix.", incorrect: "It's a discrepancy worth chasing. The IRP5 and your payslips should reconcile to the rand." } } },
      { variantId: "txx-ct-cp-mcq", step: { type: "mcq", question: "What should you do with your IRP5 when it arrives?", options: ["Check it against your payslips before your return is filed", "File it away unread", "Send it to SARS yourself", "Wait for SARS to correct any errors"], correct: 0, feedback: { correct: "Right. Errors are far easier to fix before assessment than after, and SARS won't spot them for you.", incorrect: "Reconcile it against your payslips. SARS already has the employer's copy and assesses on it." } } },
  ...
  },
  {
    ...
    conceptId: "tax-certificates",
    variants: [
      { variantId: "txx-ct-kr-mcq", step: { type: "mcq", question: "How long should you keep tax certificates and supporting documents?", options: ["At least five years from submission, in case SARS verifies the return", "Until the refund arrives", "One year", "There's no need to keep them"], correct: 0, feedback: { correct: "Right. SARS can request supporting documents well after assessment, and 'I threw it away' isn't a defence.", incorrect: "Five years from submission. Verification requests often arrive long after the refund." } } },
...
const donSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "donations-tax",
    variants: [
      { variantId: "txx-dn-wp-mcq", step: { type: "mcq", question: "Who is liable for donations tax?", options: ["The donor, within a set period after the donation", "The recipient, on assessment", "Both, split equally", "Nobody. It's collected at death"], correct: 0, feedback: { correct: "Right, and SARS can hold the recipient jointly liable if the donor doesn't pay.", incorrect: "The donor pays, and there's a deadline, it isn't settled through the annual return." } } },
      ...
      { variantId: "txx-dn-wp-sc", step: { type: "scenario", question: "Nomsa wants to help her son with a R300 000 deposit. What's a reasonable structure to discuss with an adviser?", options: ["Use the annual exemption across years, or lend the money on a formal loan account", "Give it all at once and hope SARS doesn't notice", "Disguise it as a salary payment", "Route it through a friend"], correct: 0, feedback: { correct: "Right. Staged gifts and formal loans are both recognised structures, though interest-free loans have their own rules.", incorrect: "Structure it properly. Concealment is evasion, and SARS sees large property deposits." } } },
    ],
  },
  {
...
const invTaxSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "txx-iv-cg-mcq", step: { type: "mcq", question: "What is the maximum effective CGT rate for an individual?", options: ["About 18%", "45%", "40%", "20%"], correct: 0, feedback: { correct: "Right. 40% × 45% = 18%, which is why capital gains are taxed far more lightly than salary.", incorrect: "40% inclusion × 45% top marginal rate = 18% effective." } } },
  ...
  },
  {
    ...
    conceptId: "tfsa",
    variants: [
      { variantId: "txx-iv-wc-mcq", step: { type: "mcq", question: "Why does holding the same fund inside a TFSA beat holding it in a taxable account?", options: ["Identical investment, but no tax on interest, dividends or gains", "The fund performs better inside a TFSA", "Fees are waived inside a TFSA", "The TFSA guarantees your capital"], correct: 0, feedback: { correct: "Right. Same fund, same fees, same returns. The difference is entirely tax, and it compounds.", incorrect: "It's purely the tax treatment. Returns and fees are identical; the tax saving is what accumulates." } } },
...
const efSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "txx-ef-wf-mcq", step: { type: "mcq", question: "What do you need before you can file on eFiling?", options: ["A registered eFiling profile with your tax number and verified security details", "A visit to a SARS branch each year", "An accountant's login", "A company registration"], correct: 0, feedback: { correct: "Right, and keeping your contact details and banking details current on the profile is what prevents refund delays.", incorrect: "Just a registered profile. Keep the security and banking details current so refunds aren't held up." } } },
      { variantId: "txx-ef-wf-sc", step: { type: "scenario", question: "Lerato's refund hasn't arrived weeks after assessment. What's the most common cause?", options: ["Unverified or outdated banking details on her eFiling profile", "SARS not processing refunds that year", "Her employer withholding it", "The refund expired"], correct: 0, feedback: { correct: "Right. SARS won't pay into unverified details. Checking the profile is the first thing to do.", incorrect: "It's usually banking details. Verify them on eFiling before assuming something worse." } } },
    ],
  },
  {
    ...
    conceptId: "efiling",
    variants: [
      { variantId: "txx-ef-ba-mcq", step: { type: "mcq", question: "What should you do before accepting a SARS auto-assessment?", options: ["Check it against your IRP5, IT3s and any deductions SARS doesn't know about", "Accept it immediately to get the refund faster", "Wait for the deadline to pass", "Phone SARS to confirm it's genuine"], correct: 0, feedback: { correct: "Right. SARS only sees third-party data, a private RA or unclaimed medical expenses won't be in there.", incorrect: "Check it first. Accepting an incomplete assessment can cost you a legitimate refund." } } },
      ...
      { variantId: "txx-ef-ba-sc", step: { type: "scenario", question: "Thabo's auto-assessment shows he owes R3 200, but he has R28 000 of unclaimed RA contributions. What should he do?", options: ["Reject it and file a return claiming the RA", "Accept and pay the R3 200", "Ignore it entirely", "Ask his employer to amend the IRP5"], correct: 0, feedback: { correct: "Right. At a 31% rate that R28 000 is worth about R8 680: likely turning what he owes into a refund.", incorrect: "File the return with the RA claim. Accepting means paying tax on income the deduction should have removed." } } },
    ],
  },
  {
    ...
    conceptId: "efiling",
    variants: [
      { variantId: "txx-ef-sd-mcq", step: { type: "mcq", question: "You submit your return and get a 'Supporting Documents Required' notice. What does it mean?", options: ["SARS is verifying your claims and you must upload proof by the stated deadline", "Your return was rejected", "You're being audited for fraud", "You must visit a branch"], correct: 0, feedback: { correct: "Right. Routine verification. Upload the documents on eFiling within the deadline and the assessment continues.", incorrect: "It's a verification request, not a rejection. Upload the proof on eFiling before the deadline." } } },
      ...
      { variantId: "txx-ef-sd-sc", step: { type: "scenario", question: "SARS asks Nomsa for proof of her medical expenses. What should she upload?", options: ["Her medical scheme tax certificate and receipts for out-of-pocket costs", "A written explanation", "Her bank card", "Nothing, the scheme reports it already"], correct: 0, feedback: { correct: "Right. The scheme certificate covers contributions; the receipts cover what she paid herself and claimed on top.", incorrect: "The scheme certificate plus receipts for anything paid out of pocket. Explanations aren't evidence." } } },
    ],
  },
  {
    ...
    variants: [
      { variantId: "txx-ef-dl-mcq", step: { type: "mcq", question: "Why does filing on time matter even when you can't pay what you owe?", options: ["The late-filing penalty is separate from the amount owed and runs monthly", "SARS waives the debt if you file", "Filing late is a criminal offence immediately", "The refund doubles"], correct: 0, feedback: { correct: "Right. Filing stops the admin penalty; the payment can then be handled through an arrangement.", incorrect: "The penalty runs on the outstanding return, independent of the outstanding payment." } } },
...
const assessSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "tax-filing",
    variants: [
      { variantId: "txx-as-cf-mcq", step: { type: "mcq", question: "Lerato receives an assessment showing she owes SARS R6 400. What's her first step?", options: ["Compare it line by line against her IRP5, IT3s and deduction records", "Pay it immediately", "Object without checking", "Ignore it until SARS follows up"], correct: 0, feedback: { correct: "Right. Assessments are generated from reported data, and the gap between that and reality is where most errors live.", incorrect: "Check the detail first. Paying or objecting blindly are both premature." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "txx-as-mf-mcq", step: { type: "mcq", question: "Which situation makes filing worthwhile even when it isn't compulsory?", options: ["You contributed to a private RA your employer doesn't know about", "You changed banks during the year", "You moved house", "You received a salary increase"], correct: 0, feedback: { correct: "Right. A deduction SARS has no record of only reaches you if you file and claim it.", incorrect: "Unclaimed deductions (a private RA, out-of-pocket medical costs, a travel logbook) are the reason to file voluntarily." } } },
      { variantId: "txx-as-mf-sc", step: { type: "scenario", question: "Ayesha has one employer, correct PAYE and R18 000 of out-of-pocket medical expenses. Should she file?", options: ["Yes. Those expenses can only be claimed on a return", "No, it isn't compulsory", "Only if she earns above the threshold", "Only if SARS asks"], correct: 0, feedback: { correct: "Right. The additional medical expenses credit is claimed on assessment, and skipping the return means forfeiting it.", incorrect: "File. Out-of-pocket medical expenses aren't on the IRP5 and can only reach SARS through a return." } } },
    ],
  },
  {
    ...
    conceptId: "tax-deductions",
    variants: [
      { variantId: "txx-as-ce-mcq", step: { type: "mcq", question: "Which item is most commonly missing from an auto-assessment?", options: ["A retirement annuity held outside the employer", "Your salary", "PAYE deducted", "Your UIF contribution"], correct: 0, feedback: { correct: "Right. Employer-linked figures flow through automatically; a private RA has to be claimed by you.", incorrect: "The private RA. Salary, PAYE and UIF all come straight off the IRP5." } } },
      ...
      { variantId: "txx-as-ce-sc", step: { type: "scenario", question: "Sipho's assessment omits his travel logbook claim. What does he need to succeed on objection?", options: ["A SARS-compliant logbook with dates, kilometres, destinations and business purpose", "A letter from his employer", "Fuel slips only", "His vehicle finance agreement"], correct: 0, feedback: { correct: "Right. Without those four elements per trip, the claim fails regardless of how much he genuinely drove.", incorrect: "The compliant logbook. Fuel slips and letters don't establish business kilometres." } } },
    ],
  },
  {
    ...
    conceptId: "tax-filing",
    variants: [
      { variantId: "txx-as-op-mcq", step: { type: "mcq", question: "How do you formally dispute a SARS assessment?", options: ["Lodge a notice of objection on eFiling within the prescribed period", "Send an email to any SARS address", "Post a complaint on social media", "Refuse to pay until they contact you"], correct: 0, feedback: { correct: "Right, and the deadline matters. A late objection needs SARS to condone it, which isn't guaranteed.", incorrect: "It's a formal objection on eFiling, within the prescribed period, with evidence attached." } } },
      ...
      { variantId: "txx-as-op-sc", step: { type: "scenario", question: "Lerato objects but SARS disallows it. What's her next step?", options: ["Appeal, and if needed escalate to the Tax Ombud or the tax court", "Accept the outcome as final", "Re-submit the same objection", "Stop filing returns"], correct: 0, feedback: { correct: "Right. There's a defined escalation path, and the Tax Ombud handles procedural complaints free of charge.", incorrect: "There's an appeal process beyond objection, plus the Tax Ombud for procedural issues." } } },
    ],
  },
];
