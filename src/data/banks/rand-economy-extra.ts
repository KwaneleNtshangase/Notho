...
const offSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "rex-of-jf-mcq", step: { type: "mcq", question: "You buy a JSE-listed global equity ETF in rands. What have you actually got?", options: ["Exposure to global shares and to the rand's movement, bought entirely locally", "A foreign bank account", "Exposure only to the JSE", "A currency trade with no share exposure"], correct: 0, feedback: { correct: "Right. Your return combines what the underlying shares do and what the rand does: bought in rands, on the JSE.", incorrect: "It's global share exposure plus currency exposure, purchased locally in rands." } } },
      ...
      { variantId: "rex-of-jf-sc", step: { type: "scenario", question: "Lerato has R1 000 a month and wants global exposure without paperwork. What fits?", options: ["A monthly debit order into a JSE-listed global ETF", "Opening an offshore bank account", "Applying for SARS clearance to externalise funds", "Buying foreign currency cash"], correct: 0, feedback: { correct: "Right. It's the simplest route: local platform, rand debit order, global exposure, no allowances used.", incorrect: "A JSE-listed global ETF. Offshore accounts and clearances are for externalising larger amounts." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "rex-of-ce-mcq", step: { type: "mcq", question: "What are the two components of a rand investor's return on a global ETF?", options: ["The underlying market return and the currency movement", "Dividends and fees", "Interest and inflation", "Only the share price"], correct: 0, feedback: { correct: "Right, and in some years the currency component is larger than the market one.", incorrect: "Market return plus currency movement. Both can be positive or negative independently." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "rex-of-al-sc", step: { type: "scenario", question: "Johan wants direct offshore exposure in dollars rather than a local feeder fund. What's involved?", options: ["Externalising funds under his allowance", "Nothing. It's identical to buying on the JSE", "SARB approval for any amount", "It isn't permitted for individuals"], correct: 0, feedback: { correct: "Right, and for most investors the local feeder achieves the same exposure with far less friction and cost.", incorrect: "It means externalising funds under your allowance, with forex margins and paperwork. The feeder fund avoids both." } } },
    ],
  },
  {
    ...
    variants: [
      { variantId: "rex-of-r2-mcq", step: { type: "mcq", question: "What does Regulation 28 limit?", options: ["How much of a retirement fund may be held offshore and in each asset class", "How much you may invest offshore in total", "How much you may save each year", "How much tax you pay on offshore returns"], correct: 0, feedback: { correct: "Right. The offshore limit is 45%, and it applies only to retirement funds, not to your discretionary investments.", incorrect: "It governs retirement fund composition, including a 45% offshore limit. Discretionary money is unrestricted." } } },
      ...
      { variantId: "rex-of-r2-sc", step: { type: "scenario", question: "Priya's RA is at the 45% offshore limit but she wants more global exposure. What's her option?", options: ["Add offshore exposure through her discretionary investments", "Ask her fund for an exemption", "Withdraw from her RA", "Nothing can be done"], correct: 0, feedback: { correct: "Right. Look at total exposure across all accounts, the RA constraint doesn't limit the rest of her portfolio.", incorrect: "Use her discretionary portfolio. Reg 28 binds the RA, not everything she owns." } } },
    ],
  },
];
...
const petrolSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "petrol-price",
    variants: [
      { variantId: "rex-pt-wc-mcq", step: { type: "mcq", question: "You can't control the petrol price. What can you control?", options: ["Trip planning, vehicle efficiency, tyre pressure and how often you drive", "The fuel levy", "The rand", "The oil price"], correct: 0, feedback: { correct: "Right. Consolidating trips and keeping tyres correctly inflated are unglamorous but they measurably cut consumption.", incorrect: "Only your own usage and efficiency. The other three are outside any individual's influence." } } },
      ...
      { variantId: "rex-pt-wc-sc", step: { type: "scenario", question: "Sipho's transport costs keep breaking his budget. What's the structural fix?", options: ["Budget a realistic average with a buffer, and reduce consumption where he can", "Assume prices will fall back", "Stop budgeting for fuel", "Buy a bigger car for comfort"], correct: 0, feedback: { correct: "Right. A realistic average plus a buffer beats budgeting for the best case and being surprised every quarter.", incorrect: "Budget realistically with a buffer. Hoping for a reversal is what keeps breaking the budget." } } },
    ],
  },
];
...
const hedgeSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "rand-hedge",
    variants: [
      { variantId: "rex-hg-hw-sc", step: { type: "scenario", question: "The rand weakens from R14/$ to R19/$, about 36%. An investor with 40% of their portfolio in a global ETF experiences roughly what currency effect on the whole portfolio?", options: ["About a 14% gain from currency alone", "A 36% gain", "A 36% loss", "No effect"], correct: 0, feedback: { correct: "40% × 36% ≈ 14% at the portfolio level, before anything the underlying markets did. That's the hedge working.", incorrect: "Only the offshore portion benefits: 40% × 36% ≈ 14% across the portfolio." } } },
      { variantId: "rex-hg-hw-mcq", step: { type: "mcq", question: "What does a rand hedge actually protect against?", options: ["A decline in the rand's purchasing power against foreign goods and assets", "All investment losses", "Inflation in general", "Market crashes"], correct: 0, feedback: { correct: "Right, and it's specific. Global markets can still fall. The hedge is against currency, not against risk.", incorrect: "Currency risk specifically. Offshore assets can still lose value in their own currency." } } },
  ...
  },
  {
    ...
    conceptId: "offshore-allocation",
    variants: [
      { variantId: "rex-hg-hm-mcq", step: { type: "mcq", question: "What should determine your offshore allocation?", options: ["Your goals, horizon and how much SA exposure you already carry through income and property", "The rand's level this month", "Whatever performed best last year", "The maximum allowed"], correct: 0, feedback: { correct: "Right. Someone with a rand salary and a bond already carries heavy SA exposure before their portfolio starts.", incorrect: "Your total picture, not the current exchange rate. Timing the rand is not a strategy." } } },
      ...
      { variantId: "rex-hg-hm-sc", step: { type: "scenario", question: "Ayesha wants offshore exposure but is unsure about timing. What's a practical approach?", options: ["Contribute a fixed monthly amount regardless of the exchange rate", "Wait for the rand to strengthen", "Move everything at once when it feels right", "Avoid offshore investing entirely"], correct: 0, feedback: { correct: "Right. Regular contributions average her exchange rate the same way they average her entry price.", incorrect: "Regular contributions. Waiting for the 'right' rate is a forecast nobody makes reliably." } } },
    ],
  },
];
...
const sarbSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "rex-sb-rr-mcq", step: { type: "mcq", question: "When the SARB raises the repo rate, what's the typical effect on the rand?", options: ["Supportive: higher yields attract foreign capital into rand assets", "Immediate weakening", "No effect at all", "It always halves"], correct: 0, feedback: { correct: "Right, though it's a tendency rather than a rule. Global risk sentiment can overwhelm it entirely.", incorrect: "Higher rates tend to support the currency by attracting capital, though other forces can dominate." } } },
  ...
  },
  {
    ...
    conceptId: "sarb-intervention",
    variants: [
      { variantId: "rex-sb-rs-mcq", step: { type: "mcq", question: "Why does the rand often move sharply on global news that has nothing to do with SA?", options: ["It's a highly traded emerging-market currency used as a proxy for risk appetite", "SA's economy is unusually large", "The SARB trades it actively", "It's pegged to commodity prices"], correct: 0, feedback: { correct: "Right. Its liquidity makes it a convenient risk proxy, so global sentiment moves it before any local news does.", incorrect: "Liquidity and its role as an EM risk proxy. Global risk-off moves hit the rand regardless of local conditions." } } },
  ...
  },
  {
    ...
    variants: [
      { variantId: "rex-sb-wm-mcq", step: { type: "mcq", question: "The SARB cuts the repo rate by 0.25% and your home loan is at prime minus 0.5%. What happens?", options: ["Your rate falls by 0.25%", "Nothing until you renegotiate", "Your rate falls by 0.5%", "Your rate rises"], correct: 0, feedback: { correct: "Right. Prime moves point for point with the repo rate, and your discount to prime stays the same.", incorrect: "Prime tracks the repo rate, so a 0.25% cut lowers your rate by 0.25%. Your margin is unchanged." } } },
      ...
      { variantId: "rex-sb-wm-sc", step: { type: "scenario", question: "Rates rise and Nomsa's bond instalment increases by R900. What's the constructive response?", options: ["Adjust the budget now, and treat any future cut as a chance to keep paying the higher amount", "Wait for rates to fall", "Extend the bond term", "Stop other savings entirely"], correct: 0, feedback: { correct: "Right. Keeping the higher payment after a cut turns a rate cycle into a shorter bond.", incorrect: "Adjust and plan ahead. Extending the term lowers the payment but raises total interest substantially." } } },
    ],
  },
  {
...
const tradeSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "rex-tr-ei-mcq", step: { type: "mcq", question: "Who benefits most from a weaker rand?", options: ["Exporters and tourism operators earning foreign currency", "Importers of consumer goods", "People travelling abroad", "Anyone buying imported electronics"], correct: 0, feedback: { correct: "Right. Exporters earn dollars and pay costs in rands, so a weaker rand widens their margins.", incorrect: "Exporters and tourism. The other three all become more expensive when the rand weakens." } } },
      { variantId: "rex-tr-ei-sc", step: { type: "scenario", question: "SA's trade surplus improves unexpectedly as commodity prices surge. What's the likely market reaction?", options: ["The rand tends to strengthen on the improved inflow of foreign currency", "The rand weakens", "The repo rate automatically rises", "Nothing changes"], correct: 0, feedback: { correct: "Right. A larger surplus means more dollars converted into rands, which supports the currency.", incorrect: "The rand tends to strengthen. A trade surplus increases the supply of foreign currency." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      { variantId: "rex-tr-df-mcq", step: { type: "mcq", question: "Why is forecasting the rand so unreliable?", options: ["It responds to global sentiment, commodities, politics and rate differentials at once", "Nobody studies it", "It's randomly assigned", "It only moves once a year"], correct: 0, feedback: { correct: "Right. Too many interacting drivers, which is why professional forecasts routinely miss by wide margins.", incorrect: "Too many simultaneous drivers. Even well-resourced forecasters get it wrong regularly." } } },
      ...
      { variantId: "rex-tr-df-sc", step: { type: "scenario", question: "A commentator confidently predicts the rand will hit a specific level by year-end. How should Priya treat that?", options: ["As one view among many, nobody forecasts currencies reliably", "As a reason to act immediately", "As a guarantee", "As irrelevant to everything"], correct: 0, feedback: { correct: "Right. Confidence isn't accuracy, and acting decisively on a currency call is how people transfer at bad rates.", incorrect: "Treat it as opinion. Currency forecasts are frequently wrong, however confidently stated." } } },
    ],
  },
];
...
const repoSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "repo-rate-effect",
    variants: [
      { variantId: "rex-rp-wi-mcq", step: { type: "mcq", question: "What is the repo rate?", options: ["The rate at which the SARB lends to commercial banks", "The rate banks charge their best customers", "The rate on government bonds", "The inflation rate"], correct: 0, feedback: { correct: "Right, and it's the anchor for everything else. Prime sits at repo + 3.5%, and your loan prices off prime.", incorrect: "It's the SARB's lending rate to banks. Prime is repo + 3.5%, and retail rates key off prime." } } },
  ...
  },
  {
    ...
    conceptId: "repo-rate-effect",
    variants: [
      { variantId: "rex-rp-ww-mcq", step: { type: "mcq", question: "A repo rate increase is bad for borrowers. Who benefits?", options: ["Savers, whose deposit and money market rates rise", "Nobody", "Home loan holders", "People with credit card debt"], correct: 0, feedback: { correct: "Right. Every rate decision moves money between borrowers and savers, which is why the MPC is never universally popular.", incorrect: "Savers benefit. Deposit and money market rates rise with the repo rate." } } },
  ...
  },
  {
    ...
    conceptId: "repo-rate-effect",
    variants: [
      { variantId: "rex-rp-tr-mcq", step: { type: "mcq", question: "How does raising interest rates reduce inflation?", options: ["Borrowing costs rise and spending falls, easing demand pressure on prices", "It directly caps prices by law", "It strengthens the rand only", "It increases the money supply"], correct: 0, feedback: { correct: "Right, and it works with a lag. The effect on prices arrives months after the decision.", incorrect: "By cooling demand. Higher borrowing costs reduce spending, which eases price pressure over time." } } },
      ...
      { variantId: "rex-rp-tr-sc", step: { type: "scenario", question: "Why does the SARB sometimes raise rates when the economy is already weak?", options: ["Because unchecked inflation damages the economy more, especially the poorest", "To punish borrowers", "To strengthen the rand for exporters", "Because it must follow the US Federal Reserve"], correct: 0, feedback: { correct: "Right. High inflation erodes wages and savings hardest at the bottom, which is why price stability comes first.", incorrect: "Because inflation is the greater harm. It's a mandate decision, not a reaction to other central banks." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "rex-rp-yd-sc", step: { type: "scenario", question: "Ayesha qualifies for a bond at the maximum the bank allows, at current rates. What's the risk?", options: ["A rate rise could push the instalment beyond what she can afford", "Nothing, the bank checked", "Her rate is fixed for the term", "Rates never rise"], correct: 0, feedback: { correct: "Right. Bank approval reflects today's rate and their risk appetite, not her comfort three hikes from now.", incorrect: "Rate risk. Approval at today's rate says nothing about affordability at a higher one." } } },
    ],
  },
];
...
const mpcSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "rex-mp-tg-mcq", step: { type: "mcq", question: "What is the SARB's inflation target?", options: ["3%, with a tolerance band of one percentage point either side", "Between 3% and 6%", "Below 10%", "There is no target"], correct: 0, feedback: { correct: "Right. SA moved from the old 3–6% range to a 3% point target with a ±1 percentage point band.", incorrect: "It's a 3% point target with a ±1 percentage point tolerance band, replacing the previous 3–6% range." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "rex-mp-rr-mcq", step: { type: "mcq", question: "Why does the real return matter more than the headline interest rate?", options: ["It shows whether your money is actually buying more than before", "It's always higher", "It excludes tax", "Banks advertise it"], correct: 0, feedback: { correct: "Right. A 10% return with 12% inflation leaves you poorer, despite the number looking good.", incorrect: "It measures purchasing power. A high nominal rate can still be a real loss." } } },
  ...
  },
  {
    ...
    conceptId: "inflation-targeting",
    variants: [
      { variantId: "rex-mp-wd-mcq", step: { type: "mcq", question: "What should an ordinary saver actually do about MPC decisions?", options: ["Stress-test debt affordability and keep long-term money in assets that beat inflation", "Trade around each announcement", "Move to cash before every meeting", "Ignore inflation entirely"], correct: 0, feedback: { correct: "Right. Rate decisions matter through your debt and your real returns, not as trading signals.", incorrect: "Focus on debt affordability and real returns. Trading around announcements is noise." } } },
      ...
      { variantId: "rex-mp-wd-sc", step: { type: "scenario", question: "Sipho hears rates may rise twice this year. What's a sensible response?", options: ["Check that his bond and car payments still work at a higher rate, and build a buffer", "Sell his investments", "Take on more debt before rates rise", "Do nothing at all"], correct: 0, feedback: { correct: "Right. Stress-testing his own position is useful whether or not the forecast turns out to be right.", incorrect: "Stress-test and build a buffer. Borrowing ahead of rises increases exposure to exactly the risk he's worried about." } } },
    ],
  },
];
...
const repoAppSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "repo-rate-effect",
    variants: [
      { variantId: "rex-ra-mc-sc", step: { type: "scenario", question: "CPI has risen to 7.2%, well above the SARB's target, and the MPC raises the repo rate. What links higher rates to lower inflation?", options: ["Borrowing costs rise, spending and credit demand fall, and price pressure eases", "Retailers are legally required to cut prices", "The rand is fixed at a stronger level", "Import duties are reduced"], correct: 0, feedback: { correct: "Right, and it works with a lag of many months, which is why the MPC acts on forecasts rather than the latest print.", incorrect: "It works through demand: dearer credit reduces spending, which eases pressure on prices." } } },
      { variantId: "rex-ra-mc-mcq", step: { type: "mcq", question: "Which channel transmits a repo rate change to households fastest?", options: ["Variable-rate debt, where instalments adjust within a month or two", "Grocery prices", "Wages", "Property values"], correct: 0, feedback: { correct: "Right. Bonds, car finance and credit cards reprice almost immediately; everything else takes far longer.", incorrect: "Variable-rate debt. Bonds and credit repricing is the first thing households feel." } } },
  ...
  },
  {
    ...
    conceptId: "repo-rate-effect",
    variants: [
      { variantId: "rex-ra-wb-mcq", step: { type: "mcq", question: "The repo rate rises. Which group benefits?", options: ["Savers and retirees living off interest income", "Home loan holders", "People with car finance", "Anyone with a credit card balance"], correct: 0, feedback: { correct: "Right. A retiree with money in a money market fund sees their income rise as borrowers' costs go up.", incorrect: "Savers. Everyone else on that list holds variable-rate debt that becomes more expensive." } } },
      { variantId: "rex-ra-wb-sc", step: { type: "scenario", question: "Lerato has no debt and R500 000 in a money market fund. Rates rise 1%. What's the effect?", options: ["Roughly R5 000 a year more in interest income", "R500 more", "Nothing changes", "Her capital falls 1%"], correct: 0, feedback: { correct: "R500 000 × 1% = R5 000 a year more, taxable above her R23 800 interest exemption.", incorrect: "R500 000 × 1% = R5 000 more a year in interest." } } },
  ...
  },
  {
    ...
    conceptId: "repo-rate-effect",
    variants: [
      { variantId: "rex-ra-ac-mcq", step: { type: "mcq", question: "Rates have just risen. What's the most useful action for someone with a bond?", options: ["Recheck the budget at the new instalment and protect the emergency fund", "Fix the rate immediately at any cost", "Extend the loan term", "Stop paying into retirement savings"], correct: 0, feedback: { correct: "Right. The emergency fund is what stops a rate cycle turning into a credit-card cycle.", incorrect: "Reassess the budget and protect the buffer. Extending the term or cutting retirement savings are expensive last resorts." } } },
