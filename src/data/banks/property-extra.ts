...
const brSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "ppx-br-mg-mcq", step: { type: "mcq", question: "Which costs do people most often leave out when comparing buying to renting?", options: ["Rates, levies and maintenance", "The monthly bond repayment itself", "The monthly rental amount you pay", "The deposit amount you must pay"], correct: 0, feedback: { correct: "Right. The bond is the visible number; the other four are what turn a 'similar' comparison into thousands of rands a month.", incorrect: "The running costs. Rates, levies, insurance and maintenance. They're invisible to a renter and unavoidable for an owner." } } },
  ...
  },
  {
    ...
    conceptId: "bond-vs-rent",
    variants: [
      { variantId: "ppx-br-th-mcq", step: { type: "mcq", question: "Why does how long you'll stay matter so much in a buy-or-rent decision?", options: ["Transaction costs take years", "Bond rates change with tenure", "Rent is fixed for life", "Rates and levies fall over time"], correct: 0, feedback: { correct: "Right. Those upfront costs run to several percent of the price, and selling adds agent commission on top. A short stay rarely recovers them.", incorrect: "It's the entry and exit costs. They need years of price growth before buying comes out ahead." } } },
      ...
      { variantId: "ppx-br-th-sc", step: { type: "scenario", question: "Zanele's job may relocate her in two years. How should that affect the decision?", options: ["Strongly toward renting", "It's irrelevant to the financial maths", "Toward buying, since she can rent it out", "Toward buying, because property always rises"], correct: 0, feedback: { correct: "Right. Being forced to sell into whatever market exists in two years is a real risk, and renting it out is its own business.", incorrect: "It matters a lot. A likely move within two years is one of the strongest arguments for renting." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "ppx-br-td-mcq", step: { type: "mcq", question: "A flat sells for R1.5 million. Roughly how much transfer duty is payable?", options: ["About R8 700", "R45 000, 3% of the price", "Nothing, it's under R2 million", "About R120 000"], correct: 0, feedback: { correct: "Right. Duty applies only to the portion above R1 210 000: 3% × R290 000 = R8 700.", incorrect: "Only the excess is taxed: R1 500 000 − R1 210 000 = R290 000, at 3% = R8 700." } } },
