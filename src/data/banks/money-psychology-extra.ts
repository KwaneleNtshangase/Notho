...
const hedSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mpx-hd-wi-mcq", step: { type: "mcq", question: "What is hedonic adaptation?", options: ["The tendency to return to your usual level of happiness after a change, good or bad", "The habit of spending more as you earn more", "The tendency to overvalue things you own", "A preference for immediate rewards"], correct: 0, feedback: { correct: "Right. The new car thrills you for weeks, then becomes the car, which is why upgrades so rarely deliver what they promised.", incorrect: "It's the return to baseline after a change. Spending more as you earn more is lifestyle inflation, a related but different thing." } } },
  ...
  },
  {
    ...
    conceptId: "hedonic-adaptation",
    variants: [
      { variantId: "mpx-hd-ex-mcq", step: { type: "mcq", question: "Why do experiences tend to resist adaptation better than possessions?", options: ["They become memories and stories rather than a fixed object you see daily", "They cost more", "They're shared with others", "They can't be compared"], correct: 0, feedback: { correct: "Right. A possession sits there becoming ordinary; a trip gets retold and often improves in the telling.", incorrect: "Memory is the mechanism. Objects become background; experiences become stories." } } },
      ...
      { variantId: "mpx-hd-ex-sc", step: { type: "scenario", question: "Lerato has R15 000 for something enjoyable. What's likely to give lasting satisfaction?", options: ["A trip or course she'll remember, or several smaller pleasures spread over time", "One large object bought immediately", "Whatever her colleagues bought", "The most expensive thing R15 000 can buy"], correct: 0, feedback: { correct: "Right. Spreading it out defeats adaptation better than a single purchase that becomes background within weeks.", incorrect: "Experiences and spread-out smaller pleasures resist adaptation. One big object adapts fastest." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "mpx-hd-pc-sc", step: { type: "scenario", question: "Ayesha wants to enjoy her spending more without spending more. What's a practical approach?", options: ["Space out treats so they stay treats, and pay attention when she has them", "Buy more often so there's always something new", "Buy more expensive versions", "Stop spending on enjoyment entirely"], correct: 0, feedback: { correct: "Right. Scarcity and attention are what create enjoyment, frequency destroys it.", incorrect: "Space them out and notice them. Buying more often is exactly what flattens the pleasure." } } },
    ],
  },
];
...
const ma1Slots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mpx-m1-fg-mcq", step: { type: "mcq", question: "What is mental accounting?", options: ["Treating money differently depending on where it came from or what it's 'for'", "Doing arithmetic in your head", "Keeping a written budget", "Tracking spending in an app"], correct: 0, feedback: { correct: "Right. A rand is a rand, but we behave as though bonus rands and salary rands are different substances.", incorrect: "It's the mental labelling of money by source or purpose, which makes us treat identical rands differently." } } },
      ...
      { variantId: "mpx-m1-fg-sc", step: { type: "scenario", question: "Nomsa carefully budgets her salary but spends her R8 000 bonus in a week. What's driving that?", options: ["Mental accounting. She's labelled the bonus as 'extra' rather than income", "The bonus is genuinely different money", "She's bad with money generally", "Bonuses can't be budgeted"], correct: 0, feedback: { correct: "Right, and the fix is simple: run windfalls through the same budget as salary, deciding before they land.", incorrect: "It's the 'found money' label. Her budgeting skill is fine. The category is what's wrong." } } },
    ],
  },
  {
    ...
    conceptId: "mental-accounting",
    variants: [
      { variantId: "mpx-m1-wf-mcq", step: { type: "mcq", question: "Why does 'found money' get spent so much faster than earned money?", options: ["It's labelled as outside the budget", "It's usually smaller", "It arrives at a different time of month", "It's taxed differently"], correct: 0, feedback: { correct: "Right. The label does the work. A tax refund is money you already earned, but it doesn't feel that way.", incorrect: "It's the mental label. A refund is your own overpaid tax coming back, not a windfall." } } },
      ...
      { variantId: "mpx-m1-wf-sc", step: { type: "scenario", question: "Johan gets a R12 000 refund. What's the highest-value approach?", options: ["Run it through the same decision process he'd use for R12 000 of salary", "Spend it, since it wasn't budgeted for", "Split it evenly between fun and savings automatically", "Leave it in his account and decide later"], correct: 0, feedback: { correct: "Right. Applying the same rules removes the label's power, and leaving it in the account usually means spending it by default.", incorrect: "Treat it like salary. Undecided money in a current account gets absorbed within weeks." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "mental-accounting",
    variants: [
      { variantId: "mpx-m1-db-sc", step: { type: "scenario", question: "Sipho keeps R20 000 in savings earning 6% while carrying R20 000 on a credit card at 20%. What's happening?", options: ["Mental accounting. He's treating the two pots separately when they should be netted off", "Sensible diversification", "Correct, because savings are for emergencies", "Nothing unusual. That's normal"], correct: 0, feedback: { correct: "Right. Net of everything he's losing 14% a year, roughly R2 800, for the comfort of seeing a savings balance.", incorrect: "It's mental accounting. Paying the card saves 20%; the savings earn 6%. The gap costs him R2 800 a year." } } },
...
const ma2Slots: QuestionSlot[] = [
  {
    ...
    conceptId: "mental-accounting",
    variants: [
      { variantId: "mpx-m2-sr-sc", step: { type: "scenario", question: "You'd drive 20 minutes to save R200 on a R500 kettle, but not to save R200 on a R25 000 fridge. What's inconsistent?", options: ["The R200 saved is identical in both cases, only the proportion changed", "The kettle trip is more convenient", "The fridge saving isn't real", "Nothing. Bigger purchases work differently"], correct: 0, feedback: { correct: "Right. Your time is worth the same either way, so the R200 should be worth the same trip in both cases.", incorrect: "It's the same R200 for the same 20 minutes. We judge it as a percentage, which isn't how money works." } } },
      { variantId: "mpx-m2-sr-mcq", step: { type: "mcq", question: "Why do we treat a discount on a large purchase as less significant?", options: ["We evaluate it as a proportion of the total rather than as an absolute amount", "Large purchases have smaller discounts", "Retailers hide large discounts", "We're more tired when buying big items"], correct: 0, feedback: { correct: "Right, and it costs real money. Proportional thinking makes us casual about the largest rand amounts.", incorrect: "It's proportional thinking. R200 feels big against R500 and trivial against R25 000, though it's the same R200." } } },
  ...
  },
  {
    ...
    conceptId: "mental-accounting",
    variants: [
      { variantId: "mpx-m2-pm-mcq", step: { type: "mcq", question: "Why do people typically spend more when paying by card than by cash?", options: ["Card payment is less psychologically painful", "Cards have better prices", "Cash is harder to carry", "Retailers charge more for cash"], correct: 0, feedback: { correct: "Right. Handing over notes hurts in a way that tapping doesn't, and that pain is what moderates spending.", incorrect: "It's the reduced 'pain of paying'. The friction of cash is doing useful work." } } },
      ...
      { variantId: "mpx-m2-pm-sc", step: { type: "scenario", question: "Ayesha overspends on impulse online purchases. What's a structural fix?", options: ["Remove saved card details so each purchase requires deliberate effort", "Set a mental limit", "Shop only on weekends", "Use a card with rewards"], correct: 0, feedback: { correct: "Right. Re-entering card details creates exactly the pause that impulse buying depends on not having.", incorrect: "Add friction. Mental limits fail precisely in the moments impulse buying happens." } } },
    ],
  },
  {
    ...
    variants: [
      { variantId: "mpx-m2-rt-sc", step: { type: "scenario", question: "A car salesperson offers R8 000 of extras on a R400 000 car as 'only 2%'. What's the framing doing?", options: ["Making a substantial amount feel trivial by anchoring it to the car's price", "Offering a genuine discount", "Explaining the pricing structure", "Reducing the total cost"], correct: 0, feedback: { correct: "Right. R8 000 is R8 000. It doesn't shrink because it sits next to a larger number.", incorrect: "It's anchoring. The percentage framing is designed to make the absolute amount feel small." } } },
      { variantId: "mpx-m2-rt-mcq", step: { type: "mcq", question: "What's a reliable defence against percentage framing?", options: ["Convert everything back to rands and ask what else that amount would buy", "Trust the percentage", "Compare to the largest number in the deal", "Decide quickly before overthinking"], correct: 0, feedback: { correct: "Right. 'R8 000 is four months of groceries' lands very differently from '2%'.", incorrect: "Convert to rands and compare to something concrete. Percentages are how small-sounding costs get through." } } },
...
const confSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mpx-cf-wi-mcq", step: { type: "mcq", question: "What is confirmation bias?", options: ["Seeking and believing information that supports what you already think", "Following the crowd", "Overestimating your own ability", "Preferring immediate rewards"], correct: 0, feedback: { correct: "Right, and it's mostly invisible. It feels like research, because you genuinely are reading things.", incorrect: "It's the tendency to favour supporting evidence. Following the crowd is herd behaviour; overestimating yourself is overconfidence." } } },
      ...
      { variantId: "mpx-cf-wi-sc", step: { type: "scenario", question: "Johan buys a share, then follows five accounts that are bullish on it and mutes the critics. What's the effect?", options: ["He's built an environment where he'll never see the warning signs", "He's filtering out noise", "He's diversifying his information", "He's reducing his risk"], correct: 0, feedback: { correct: "Right. The critics are the only source that could change his mind, which is exactly why they got muted.", incorrect: "He's engineered a feedback loop. The dissenting view is the useful one precisely because it's uncomfortable." } } },
    ],
  },
  {
    ...
    conceptId: "confirmation-bias",
    variants: [
      { variantId: "mpx-cf-ii-mcq", step: { type: "mcq", question: "How does confirmation bias typically show up after buying an investment?", options: ["Good news feels significant and bad news feels like noise", "You sell too early", "You stop checking prices", "You diversify more"], correct: 0, feedback: { correct: "Right, and the asymmetry grows with the position size. The more you've committed, the louder the good news sounds.", incorrect: "It's the asymmetric weighting: supporting news is evidence, contradicting news gets explained away." } } },
  ...
  },
  {
    ...
    conceptId: "confirmation-bias",
    variants: [
      { variantId: "mpx-cf-co-mcq", step: { type: "mcq", question: "Which practice most effectively counters confirmation bias?", options: ["Writing your reasoning down before deciding, including what would prove you wrong", "Reading more of the same sources", "Deciding faster", "Discussing it only with people who agree"], correct: 0, feedback: { correct: "Right. Written reasoning can be checked later against what actually happened: memory quietly rewrites itself otherwise.", incorrect: "Write it down in advance, including the disconfirming conditions. That's the only version you can audit later." } } },
...
const lossSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "mpx-la-as-sc", step: { type: "scenario", question: "Nomsa's portfolio falls 15% and she can't stop checking it, though she didn't check at all when it rose 15%. What's happening?", options: ["Loss aversion. The fall commands attention in a way the rise didn't", "Her portfolio is riskier now", "She's being appropriately vigilant", "The market is more volatile"], correct: 0, feedback: { correct: "Right, and constant checking makes it worse: the more often you look, the more losses you see.", incorrect: "It's loss aversion. Frequent checking amplifies it, because short periods contain more losses than long ones." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "loss-aversion",
    variants: [
      { variantId: "mpx-la-ps-mcq", step: { type: "mcq", question: "Why is panic selling in a crash so costly?", options: ["It converts a paper loss into a real one and usually misses the recovery", "Trading fees are high", "It triggers immediate tax", "Markets never recover"], correct: 0, feedback: { correct: "Right. Recoveries tend to be concentrated in a handful of strong days, and people who sold are rarely back in time for them.", incorrect: "It realises the loss and misses the rebound, which is typically fast and easy to miss." } } },
      ...
      { variantId: "mpx-la-ps-sc", step: { type: "scenario", question: "Markets fall sharply and Lerato wants to sell everything. What would help most in that moment?", options: ["A written plan made in calm conditions that specifies what she'll do in a fall", "Watching more financial news", "Asking her most anxious friend", "Selling half to feel better"], correct: 0, feedback: { correct: "Right. The plan's whole purpose is to make the decision before the emotion arrives.", incorrect: "A pre-written plan. News and anxious friends amplify the feeling rather than resolving it." } } },
    ],
  },
  {
    ...
    conceptId: "loss-aversion",
    variants: [
      { variantId: "mpx-la-fr-mcq", step: { type: "mcq", question: "How do marketers exploit loss aversion?", options: ["Framing offers as things you'll lose rather than gain. 'don't miss out'", "By offering discounts", "By explaining features", "By comparing products"], correct: 0, feedback: { correct: "Right. 'Save R500' and 'lose R500 if you don't act' describe the same thing, but the second one moves people more.", incorrect: "Loss framing. 'Don't miss out' outperforms 'gain this' because the pain of loss is stronger." } } },
...
const overSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mpx-ov-aa-mcq", step: { type: "mcq", question: "What does overconfidence bias look like in investing?", options: ["Believing you can pick winners or time markets better than you actually can", "Refusing to invest", "Following expert advice too closely", "Diversifying excessively"], correct: 0, feedback: { correct: "Right, and it's measurable: more confident investors trade more, and more trading reliably reduces net returns.", incorrect: "It's overestimating your own skill or judgement, typically expressed through more frequent trading." } } },
      ...
      { variantId: "mpx-ov-aa-sc", step: { type: "scenario", question: "Johan made money on three trades and now believes he has a knack for it. What's the risk?", options: ["Three outcomes can't distinguish skill from luck, but they can justify much bigger bets", "He should trade more to confirm it", "He's proven his ability", "He should teach others"], correct: 0, feedback: { correct: "Right, and the position sizes usually grow just before the run ends. That's the expensive part.", incorrect: "Three results are far too few to establish skill, but quite enough to build dangerous confidence." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "overconfidence-bias",
    variants: [
      { variantId: "mpx-ov-hs-mcq", step: { type: "mcq", question: "What is hindsight bias?", options: ["Believing after the fact that you knew what was going to happen", "Regretting past decisions", "Forgetting past losses", "Refusing to review decisions"], correct: 0, feedback: { correct: "Right, and it's corrosive: it convinces you that unpredictable events were predictable, which feeds overconfidence.", incorrect: "It's the 'I knew it all along' effect, which quietly manufactures confidence you haven't earned." } } },
      ...
      { variantId: "mpx-ov-hs-sc", step: { type: "scenario", question: "After a crash, Sipho is certain the warning signs were obvious. How can he test that?", options: ["Check whether he wrote anything down or acted on it before the crash", "Ask friends if they agree now", "Read post-crash analysis", "Trust his memory"], correct: 0, feedback: { correct: "Right. If he saw it clearly, his portfolio would show it. Memory is not evidence.", incorrect: "Look for contemporaneous evidence, a record or an action. Post-hoc analysis and memory both confirm the bias." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "mpx-ov-hm-sc", step: { type: "scenario", question: "Nomsa enjoys picking shares but knows the odds. What's a reasonable compromise?", options: ["Keep a small, capped portion for stock-picking and index the rest", "Put everything into her picks", "Stop investing entirely", "Only pick shares she's heard of"], correct: 0, feedback: { correct: "Right. A capped satellite scratches the itch without letting it endanger the core, and it teaches her something real.", incorrect: "Cap the discretionary portion and index the core. That way the interest costs her a known, limited amount." } } },
    ],
  },
];
...
const sunkSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mpx-sk-wc-mcq", step: { type: "mcq", question: "Lerato bought a share at R80; it's now R32. What should drive her decision?", options: ["Whether she'd buy it today at R32, given what she now knows", "How much she's already lost", "Getting back to R80 first", "How long she's held it"], correct: 0, feedback: { correct: "Right. The R48 is gone either way. The only live question is whether R32 is a good use of that money now.", incorrect: "The purchase price is a sunk cost. 'Would I buy it today?' is the only decision-relevant question." } } },
  ...
  },
  {
    ...
    conceptId: "sunk-cost-fallacy",
    variants: [
      { variantId: "mpx-sk-oc-mcq", step: { type: "mcq", question: "What's the hidden cost of holding a failing investment 'until it recovers'?", options: ["The money can't work anywhere else while it waits", "Holding fees", "Tax on the loss", "Nothing. Holding is free"], correct: 0, feedback: { correct: "Right. Years spent waiting for break-even are years that money isn't compounding somewhere better.", incorrect: "Opportunity cost. Capital tied to a recovery hope isn't available for anything productive." } } },
  ...
  },
  {
    ...
    conceptId: "sunk-cost-fallacy",
    variants: [
      { variantId: "mpx-sk-bi-mcq", step: { type: "mcq", question: "Where else does the sunk cost fallacy commonly cost people money?", options: ["Unused gym memberships, failing courses and cars that keep needing repairs", "Only in share portfolios", "Only in property", "Only in business"], correct: 0, feedback: { correct: "Right. 'I've already spent so much on this car' is the same reasoning that keeps a bad share in a portfolio.", incorrect: "It shows up everywhere: subscriptions, courses, vehicles, relationships with money attached." } } },
  ...
  },
  {
    ...
    conceptId: "sunk-cost-fallacy",
    variants: [
      { variantId: "mpx-sk-dr-mcq", step: { type: "mcq", question: "What's the most useful question when deciding whether to exit an investment?", options: ["Would I buy this today at this price with fresh money?", "How much have I lost?", "How long have I held it?", "What did my friend do?"], correct: 0, feedback: { correct: "Right. If the answer is no, holding is just a sale you haven't got round to making.", incorrect: "The 'would I buy it today' test. The other three are all backward-looking or irrelevant." } } },
