...
const aaSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "sax-aa-wi-mcq", step: { type: "mcq", question: "What does asset allocation mean?", options: ["The split across asset classes", "Which individual shares you pick", "When you buy and when you sell", "Which platform you end up using"], correct: 0, feedback: { correct: "Right, and it drives most of the variation in a portfolio's returns, far more than which particular shares you own.", incorrect: "It's the split across asset classes, not the choice of individual holdings within them." } } },
  ...
  },
  {
    ...
    variants: [
      { variantId: "sax-aa-th-mcq", step: { type: "mcq", question: "What should mainly drive how much equity you hold?", options: ["Your horizon and risk tolerance", "Last year's best-performing class", "What your colleagues are buying", "The size of your account"], correct: 0, feedback: { correct: "Right. A long horizon lets you ride out falls; a short one doesn't, whatever the long-run averages say.", incorrect: "Time horizon and genuine risk tolerance. Chasing last year's winner is the opposite of an allocation decision." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "sax-aa-lo-sc", step: { type: "scenario", question: "Johan holds 100% SA assets and earns a rand salary. What's the concern?", options: ["One economy, one currency", "SA assets are inherently poor", "He will end up paying more tax", "He can't access his money"], correct: 0, feedback: { correct: "Right. It's concentration risk: a bad decade for SA hits his salary, his property and his portfolio at once.", incorrect: "The issue is concentration, not quality. Offshore exposure spreads the risk his income already carries." } } },
    ],
  },
  {
...
const rbSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "sax-rb-wd-sc", step: { type: "scenario", question: "Your target is 70% equities and 30% bonds. After a strong equity year you're at 80/20. What should you do?", options: ["Sell equities back to 70/30", "Leave it, the winners are working", "Sell all of your bonds", "Move absolutely everything into cash"], correct: 0, feedback: { correct: "Right. Drift means you're now carrying more risk than you chose. Rebalancing is how you take some of that back off the table.", incorrect: "Rebalance back to target. Letting winners run quietly raises your risk beyond what you decided you could tolerate." } } },
  ...
  },
  {
    ...
    conceptId: "rebalancing",
    variants: [
      { variantId: "sax-rb-ho-mcq", step: { type: "mcq", question: "How often should most investors rebalance?", options: ["Annually, or on a 5% drift", "Every single week", "Every time markets move", "Never at any point"], correct: 0, feedback: { correct: "Right. Rebalancing too often adds cost and tax without improving outcomes; never rebalancing lets risk creep up unchecked.", incorrect: "Annually or on a drift threshold. More frequent trading costs money without adding value." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "sax-rb-ts-mcq", step: { type: "mcq", question: "What's the most tax-efficient way to rebalance a taxable portfolio?", options: ["Direct new money to the underweight", "Sell everything and rebuild it", "Rebalance monthly to keep gains small", "Never rebalance at all"], correct: 0, feedback: { correct: "Right. Buying your way back to target avoids realising gains entirely. The cheapest rebalancing there is.", incorrect: "Use new money first. Selling realises gains; contributing doesn't." } } },
      { variantId: "sax-rb-ts-sc", step: { type: "scenario", question: "Priya needs to rebalance and holds the same funds in both a TFSA and a taxable account. Where should she trade?", options: ["Inside the TFSA", "In the taxable account, to use the exclusion", "Split the trades evenly", "Neither. She should stop contributing"], correct: 0, feedback: { correct: "Right. Do the selling where it's tax-free and leave the taxable holdings undisturbed.", incorrect: "Trade inside the tax-free wrapper. Selling in the taxable account realises gains unnecessarily." } } },
    ],
  },
  {
    ...
    conceptId: "rebalancing",
    variants: [
      { variantId: "sax-rb-di-mcq", step: { type: "mcq", question: "Why does rebalancing feel uncomfortable?", options: ["You sell what's done well", "It always loses you money", "It is quite expensive", "It requires daily attention"], correct: 0, feedback: { correct: "Right, and that discomfort is the point. It's a rule that makes you sell high and buy low when instinct says the opposite.", incorrect: "It runs against instinct: trimming winners to top up laggards. That's exactly why it works as a rule." } } },
      ...
      { variantId: "sax-rb-di-sc", step: { type: "scenario", question: "Equities have fallen hard and Thabo's rule says buy more to return to target. He's nervous. What's the honest framing?", options: ["The rule exists for exactly this", "He should abandon the rule and wait", "He should sell equities instead", "He should switch to cash for now"], correct: 0, feedback: { correct: "Right. Rules are written in calm moments to govern the frightening ones. That's their whole function.", incorrect: "Follow the rule. Abandoning it in a downturn means selling low, which is the mistake rebalancing prevents." } } },
    ],
  },
];
