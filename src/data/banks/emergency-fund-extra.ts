...
const buildSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "emergency-fund",
    variants: [
      { variantId: "efx-bd-hm-mcq", step: { type: "mcq", question: "Who should aim for six months or more rather than three?", options: ["The self-employed or sole earners", "Someone in a permanent state post", "Anyone under the age of 30", "Anyone with a credit card"], correct: 0, feedback: { correct: "Right. Income volatility and the number of people depending on you both push the target up.", incorrect: "The less predictable your income and the more people depend on it, the bigger the buffer needs to be." } } },
      ...
      { variantId: "efx-bd-hm-sc", step: { type: "scenario", question: "Lerato is a commission-only estate agent supporting two children. What's a realistic target?", options: ["Six to nine months", "About one month", "About three months", "No fund at all"], correct: 0, feedback: { correct: "Right. Commission income can vanish for a quarter at a time, and two dependants remove the option of simply cutting deeper.", incorrect: "Six to nine months. Volatile income plus dependants is the highest-buffer case." } } },
    ],
  },
  {
