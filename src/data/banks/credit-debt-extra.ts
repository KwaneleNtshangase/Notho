...
const avaSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "cdx-av-or-mcq", step: { type: "mcq", question: "Under the debt avalanche method, which debt gets every spare rand first?", options: ["The highest interest rate", "The smallest outstanding balance", "The oldest account", "The one with the largest balance"], correct: 0, feedback: { correct: "Right. Highest rate first minimises the total interest you'll ever pay, because that's where each rand of debt costs the most.", incorrect: "Avalanche targets the highest interest rate. Smallest-balance-first is the snowball method." } } },
      { variantId: "cdx-av-or-sc", step: { type: "scenario", question: "Thandi has a credit card at 22% (R12 000), a personal loan at 17% (R25 000) and car finance at 12.75% (R80 000), plus R2 000 spare a month. Her avalanche order is:", options: ["Card, then personal loan, then car", "Car finance first, it's the biggest", "Personal loan, then card, then car", "Split the R2 000 evenly"], correct: 0, feedback: { correct: "Right: 22% → 17% → 12.75%. Minimums on everything else, and each cleared payment rolls onto the next debt.", incorrect: "Sort by rate, not size: 22% card, then the 17% loan, then 12.75% car finance." } } },
  ...
  },
  {
    ...
    conceptId: "debt-avalanche",
    variants: [
      { variantId: "cdx-av-kr-mcq", step: { type: "mcq", question: "Before you can build an avalanche plan you need:", options: ["The balance and rate for each debt", "Only the total amount that you owe", "Your current credit score", "Your employer's permission"], correct: 0, feedback: { correct: "Right. Without the rates you can't sort the list, and most people underestimate what their store cards actually charge.", incorrect: "You need both balance and rate per debt. A total figure tells you nothing about which one to attack." } } },
      ...
      { variantId: "cdx-av-kr-sc", step: { type: "scenario", question: "Lerato doesn't know the rate on her clothing account. How does she find it?", options: ["Check the statement or agreement", "Assume it matches her bank card", "Estimate it from the payment", "Ask a friend with the same account"], correct: 0, feedback: { correct: "Right. The rate must be disclosed in the agreement and on statements. An assumption could put the wrong debt at the top of her list.", incorrect: "Get the actual number from the statement or agreement. Guessing can misorder the whole plan." } } },
    ],
  },
];
...
const buildSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-bs-op-sc", step: { type: "scenario", question: "Thabo pays his accounts a week late most months but always pays in full. What's the effect?", options: ["Late payments still damage his record", "No effect, the balance is settled", "It improves his score, he pays in full", "Only payments over 30 days late count"], correct: 0, feedback: { correct: "Right. A debit order timed just after payday is a cheap fix for a problem that quietly costs him rate concessions.", incorrect: "Paying in full doesn't erase lateness. The payment profile records when you paid, not just whether you did." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-bs-ut-mcq", step: { type: "mcq", question: "You owe R16 000 on a card with a R20 000 limit. What does that tell a lender?", options: ["80% utilisation, which reads as financial stress", "80% utilisation, which is fine", "20% utilisation, which is healthy", "Nothing: utilisation isn't scored"], correct: 0, feedback: { correct: "Right. Utilisation is about 30% of the score, and paying down to R6 000 would move it materially.", incorrect: "R16 000 ÷ R20 000 = 80%. Anything over 30% starts to drag; over 50% is a clear warning sign." } } },
      { variantId: "cdx-bs-ut-sc", step: { type: "scenario", question: "Nomsa's card sits at 70% utilisation. She can't pay it down this month. What else might help?", options: ["Ask for a limit she doesn't use", "Close another card to simplify", "Apply for two more cards", "Stop using credit for a whole year"], correct: 0, feedback: { correct: "Right. More available credit lowers the ratio, but only if she genuinely leaves it untouched.", incorrect: "A higher unused limit reduces utilisation. Closing a card does the opposite by shrinking available credit." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-bs-ko-mcq", step: { type: "mcq", question: "When is closing an old credit card the sensible choice?", options: ["When it carries an annual fee", "Whenever the balance reaches zero", "As soon as you get a newer card", "Every two years, to refresh your record"], correct: 0, feedback: { correct: "Right. A real cost or a real temptation beats a small scoring benefit. Otherwise leave it open.", incorrect: "Only close it for a concrete reason: a fee you're paying, or a habit you can't control." } } },
...
const dcSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "cdx-dc-wr-sc", step: { type: "scenario", question: "A company promises to 'clear your blacklisting in 30 days' for an upfront fee of R3 500. This is:", options: ["A scam, accurate listings stay", "A standard debt counselling service", "Legal but rather expensive to use", "Only available through the NCR"], correct: 0, feedback: { correct: "Right. Correct information stays for its prescribed period. Only errors can be removed, and disputing an error is free.", incorrect: "Nobody can delete accurate adverse listings. Disputing genuine errors costs you nothing." } } },
    ],
  },
  {
    ...
    conceptId: "debt-counselling",
    variants: [
      { variantId: "cdx-dc-wd-mcq", step: { type: "mcq", question: "What does debt review actually do for an over-indebted person?", options: ["Restructures repayments into one amount", "Cancels the debt outright", "Removes your credit record", "Pays your creditors from a government fund"], correct: 0, feedback: { correct: "Right. The debt doesn't vanish. It becomes affordable, and creditors can't take legal action while you comply.", incorrect: "It restructures rather than cancels. The protection lasts only while you keep up the restructured payments." } } },
  ...
  },
  {
    ...
    conceptId: "debt-counselling",
    variants: [
      { variantId: "cdx-dc-wa-sc", step: { type: "scenario", question: "Nomsa earns R18 000 a month and R13 500 goes to debt repayments. What does that tell her?", options: ["At 75% of income she is over-indebted", "It's tight but still manageable", "She should take another loan to ease it", "She should wait until she misses a payment"], correct: 0, feedback: { correct: "Right. The NCA test is whether you can meet all obligations on time with current income, at 75% she can't, and waiting only adds default listings.", incorrect: "75% of income on debt is severe over-indebtedness. Acting before the first default protects her record." } } },
      { variantId: "cdx-dc-wa-mcq", step: { type: "mcq", question: "What's the risk of waiting until you've already defaulted before seeking debt counselling?", options: ["Defaults attach and outlast the review", "Debt counselling becomes entirely unavailable", "Your interest rates are frozen automatically", "There's no downside to waiting"], correct: 0, feedback: { correct: "Right. Entering review early protects the record; entering after judgments means living with those listings for years.", incorrect: "Defaults and judgments stick to your credit record for years, long after the review ends. Early action limits the damage." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-dc-al-sc", step: { type: "scenario", question: "Sipho is offered a consolidation loan that halves his monthly payment by doubling the term at a similar rate. Should he take it?", options: [
        "Only if the cash-flow relief is genuinely needed",
        "Yes, because a lower monthly payment is always better",
        "No, consolidation is never useful",
        "Yes, because a single payment improves his credit score",
      ], correct: 0, feedback: { correct: "Right. It buys breathing room at a real cost. Worth it in a crisis, expensive as a default choice.", incorrect: "It's a trade, not a win: lower monthly, higher total. Take it only if the cash flow is genuinely the problem." } } },
    ],
  },
];
...
const rlSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-rl-rc-sc", step: { type: "scenario", question: "A registered lender charges you 45% a year when the legal cap is 28%. What should you do?", options: ["Report it to the NCR", "Pay it, you signed the agreement", "Pay it off early and say nothing", "Take another loan elsewhere to settle it"], correct: 0, feedback: { correct: "Right. Exceeding the cap is an offence for a registered provider, and the NCR can act on it.", incorrect: "Signing doesn't make an illegal rate legal. Report it to the NCR." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-rl-ma-mcq", step: { type: "mcq", question: "What's the biggest practical risk of borrowing from an unregistered lender?", options: ["No rate cap and no regulator", "Slightly slower approval times", "Having to provide a payslip", "A hard enquiry on your report"], correct: 0, feedback: { correct: "Right. Holding a borrower's bank card or ID as 'security' is also unlawful, but there's no easy route to enforce that.", incorrect: "The absence of every consumer protection is the risk, rates, conduct and recourse all disappear." } } },
      { variantId: "cdx-rl-ma-sc", step: { type: "scenario", question: "A lender asks to keep Thabo's bank card and PIN as security for a loan. This is:", options: ["Unlawful, walk away", "Standard practice for small loans", "Acceptable if the amount is small", "Required by the NCA"], correct: 0, feedback: { correct: "Right. Nobody may hold your card, PIN or SASSA card as security. Walk away and report it.", incorrect: "Holding a card or PIN as security is unlawful. That request alone is reason enough to refuse." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-rl-yr-sc", step: { type: "scenario", question: "The total repayment on Ayesha's loan is far higher than she expected. Where does she look first?", options: ["The cost-of-credit section", "Her latest bank statement", "Her full credit report", "The lender's public website"], correct: 0, feedback: { correct: "Right. Initiation and monthly service fees push the real cost well above the headline rate: the agreement itemises both.", incorrect: "The agreement's cost-of-credit disclosure is where the rate, initiation fee and service fees are set out." } } },
    ],
  },
];
...
const carSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "cdx-cr-tc-mcq", step: { type: "mcq", question: "Why does a financed car usually cost far more than its price tag?", options: ["Interest and fees across the term", "Cars are taxed twice over", "Insurance is included in the finance", "The dealer adds a mark-up at the end"], correct: 0, feedback: { correct: "Right. On a long term the finance charges alone can approach half the vehicle's value, while the car itself keeps depreciating.", incorrect: "It's the finance charges: interest plus initiation and monthly service fees over the full term." } } },
  ...
  },
  {
    ...
    conceptId: "car-finance",
    variants: [
      { variantId: "cdx-cr-bl-mcq", step: { type: "mcq", question: "What does a balloon (residual) payment actually do?", options: ["Defers 20-30% of the debt to the end", "Reduces the total that you owe", "Covers your final year's instalments", "Is written off if you return the car"], correct: 0, feedback: { correct: "Right. It makes the monthly figure look affordable while a large lump sum waits at the end, usually refinanced at more interest.", incorrect: "It defers debt rather than removing it. The lump sum is still due at the end." } } },
  ...
  },
  {
    ...
    conceptId: "car-finance",
    variants: [
      { variantId: "cdx-cr-af-sc", step: { type: "scenario", question: "Mpho earns R28 000 a month and is approved for an R8 400 car instalment. What's the problem?", options: ["The instalment is 30% of his income", "Nothing at all, the bank approved it", "He should extend to 84 months", "He needs a bigger balloon payment"], correct: 0, feedback: { correct: "Right. Insurance, fuel and maintenance still have to fit inside that 20%. Bank approval measures their risk, not his comfort.", incorrect: "20% of R28 000 is R5 600 for all transport costs. An R8 400 instalment breaks the rule before fuel or insurance." } } },
...
const hlSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-hl-ab-mcq", step: { type: "mcq", question: "What's the main advantage of an access facility on your bond?", options: ["Extra payments stay available to you", "It reduces your interest rate", "It removes the need for an emergency fund", "It shortens the loan term automatically"], correct: 0, feedback: { correct: "Right. You get the interest saving without permanently locking the money away, though redrawing does undo the saving.", incorrect: "It's about access. The money still lowers your interest while it sits there, but you can draw it back." } } },
      { variantId: "cdx-hl-ab-sc", step: { type: "scenario", question: "Johan wants his emergency fund working harder. His bond has an access facility at 11%. Reasonable approach?", options: ["Keep some cash, bond the rest", "Put every cent in and keep no cash", "Leave it all in a 1% current account", "Move it all into shares"], correct: 0, feedback: { correct: "Right. Cash for the first shock, the rest saving 11% while staying reachable. Provided redrawing is quick with his bank.", incorrect: "Keep an instantly available layer. Access bond redraws can take days, and emergencies rarely wait." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-hl-sf-sc", step: { type: "scenario", question: "Priya receives an unexpected R15 000 in year two of a 20-year bond. Best use, assuming no expensive debt elsewhere?", options: ["Pay it against the bond capital", "Keep it in a normal current account", "Upgrade the kitchen", "Wait until year fifteen to pay it in"], correct: 0, feedback: { correct: "Right. Paid in year two, that R15 000 removes far more interest than the same amount would in year fifteen.", incorrect: "Against the capital, now. Delaying wastes most of the benefit." } } },
    ],
  },
  {
...
const bnplSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "bnpl",
    variants: [
      { variantId: "cdx-bn-zp-mcq", step: { type: "mcq", question: "BNPL is advertised as 0% interest. When does that stop being true?", options: ["The moment you miss an instalment", "After the first instalment", "Only on purchases above R5 000 in value", "It is always genuinely free of charge"], correct: 0, feedback: { correct: "Right. Late fees can run to a meaningful share of the purchase, which turns a 'free' product into an expensive one overnight.", incorrect: "The 0% holds only while you pay on time. Miss one and the fees arrive." } } },
      ...
      { variantId: "cdx-bn-zp-sc", step: { type: "scenario", question: "You split a R900 purchase into three payments and miss the second by a day. What's the realistic outcome?", options: ["A late fee on a small instalment", "Nothing, one day is within grace", "Immediate blacklisting on your record", "The purchase is cancelled and refunded"], correct: 0, feedback: { correct: "Right. Fees vary by provider but are steep relative to the amount, which is exactly how the '0%' economics work.", incorrect: "A day late still triggers the fee. That fee is the real price of the product." } } },
    ],
  },
  {
    ...
    conceptId: "bnpl",
    variants: [
      { variantId: "cdx-bn-st-sc", step: { type: "scenario", question: "Sipho has four BNPL commitments running: R300, R450, R250 and R600 a month. What has he added to his budget?", options: ["R1 600 a month", "R1 200 a month", "R800 a month", "Nothing at all"], correct: 0, feedback: { correct: "R300 + R450 + R250 + R600 = R1 600. Each felt small on its own, which is precisely the trap.", incorrect: "Add them up: R1 600 a month of commitments that never appeared in his budget." } } },
      { variantId: "cdx-bn-st-mcq", step: { type: "mcq", question: "Why does BNPL make expensive things feel affordable?", options: ["It reframes the price as instalments", "It genuinely reduces the price", "It delays it until you can afford it", "It links the purchase to your income"], correct: 0, feedback: { correct: "Right. 'R600 now' lands very differently from 'R1 800', even though you owe the same money.", incorrect: "It's a framing effect. The price is unchanged; only how you perceive it changes." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-bn-wo-sc", step: { type: "scenario", question: "Thabo wants a R2 400 jacket and has R2 400 saved, but BNPL lets him keep the cash. Reasonable?", options: ["Only if he sets the money aside", "Yes, free credit is worth taking", "No, BNPL is never acceptable", "Yes, and he should invest the R2 400"], correct: 0, feedback: { correct: "Right. The risk isn't the product, it's the cash quietly getting spent before instalment two arrives.", incorrect: "It works only if the money is genuinely ring-fenced. Otherwise he's created a debt he can't cover." } } },
    ],
  },
];
...
const mechSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "credit-score",
    variants: [
      { variantId: "cdx-mc-wt-mcq", step: { type: "mcq", question: "Which two factors together drive roughly two-thirds of a credit score?", options: ["Payment history and utilisation", "Your income and your age", "Credit mix and new applications", "Length of history and income"], correct: 0, feedback: { correct: "Right. Roughly 35% and 30%. Fix those two and the rest is detail.", incorrect: "Payment history (~35%) and utilisation (~30%) dominate. Income isn't scored at all." } } },
      ...
      { variantId: "cdx-mc-wt-sc", step: { type: "scenario", question: "Nomsa wants the fastest improvement in her score. Where should she focus?", options: ["Pay on time and cut utilisation", "Opening a new type of credit for variety", "Applying to several lenders to compare", "Closing her oldest account"], correct: 0, feedback: { correct: "Right. Those are the two heaviest factors and the two she can move within a few months.", incorrect: "Target payment history and utilisation. New applications and closures work against her." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "credit-score",
    variants: [
      { variantId: "cdx-mc-en-mcq", step: { type: "mcq", question: "What happens when you apply for credit at five lenders in one week?", options: ["Several hard enquiries appear", "Nothing at all is recorded", "Your score improves from activity", "Only the successful one is recorded"], correct: 0, feedback: { correct: "Right. Space applications out, or get pre-qualification quotes that don't leave a hard enquiry.", incorrect: "Each application leaves a hard enquiry. A cluster of them signals desperation to the next lender." } } },
      ...
      { variantId: "cdx-mc-en-sc", step: { type: "scenario", question: "Johan wants to compare car finance from three banks without hurting his score. Best approach?", options: ["Get quotes, then apply in one window", "Apply formally to all three over several months", "Apply to one and accept whatever it offers", "Ask a friend to apply on his behalf"], correct: 0, feedback: { correct: "Right. Rate shopping in a tight window is treated far more kindly than applications scattered across months.", incorrect: "Pre-qualify first, then cluster any formal applications. Spreading them out looks worse, not better." } } },
    ],
  },
  {
...
const rebSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "credit-report-disputes",
    variants: [
      { variantId: "cdx-rb-sa-mcq", step: { type: "mcq", question: "You have an account in arrears. What's the first priority?", options: ["Bring it current and keep it there", "Open a new account to dilute it", "Dispute the listing regardless", "Wait for the creditor to write it off"], correct: 0, feedback: { correct: "Right. An account moving from arrears to current changes what lenders see far more than any cosmetic tactic.", incorrect: "Get it current first. Everything else is noise until the arrears are cleared." } } },
  ...
  },
  {
    ...
    conceptId: "credit-score",
    variants: [
      { variantId: "cdx-rb-sc-mcq", step: { type: "mcq", question: "What's a sensible way to rebuild a payment record after damage?", options: ["One small facility settled in full", "Several new accounts at once", "A large personal loan", "Avoiding all credit permanently"], correct: 0, feedback: { correct: "Right. You need new positive data, and the smallest safe amount of credit generates it without risk.", incorrect: "Small and perfectly managed. Multiple accounts or a large loan add risk without adding much evidence." } } },
  ...
  },
  {
    ...
    conceptId: "credit-score",
    variants: [
      { variantId: "cdx-rb-pt-mcq", step: { type: "mcq", question: "Realistically, how long does meaningful credit repair take?", options: ["Twelve to twenty-four months", "Only a few weeks", "About three months", "About ten years"], correct: 0, feedback: { correct: "Right. Improvement starts within months, but a lender-convincing record takes a year or two of clean behaviour.", incorrect: "Expect twelve to twenty-four months. Anyone promising weeks is selling something." } } },
...
const trapSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "cost-of-debt",
    variants: [
      { variantId: "cdx-lt-al-sc", step: { type: "scenario", question: "Nomsa needs a R10 000 car repair. She earns R14 000 take-home, has no other debt and a small emergency fund. What's the strongest option?", options: ["A cheaper temporary fix for now", "The 24-month loan at R509 a month", "Borrowing from a mashonisa for speed", "A BNPL split she can't cover"], correct: 0, feedback: { correct: "Right. It costs a fraction of the R2 216 in interest and leaves her with the habit of saving for the next repair.", incorrect: "Interim fix plus saving avoids R2 216 in interest. The loan is the expensive default, not the only option." } } },
      { variantId: "cdx-lt-al-mcq", step: { type: "mcq", question: "Before taking a personal loan for an unexpected expense, what's worth checking?", options: ["Whether a partial fix buys time to save", "Whether the bank could offer a longer term", "Whether a second loan could cover it", "Whether the instalment fits, and nothing else"], correct: 0, feedback: { correct: "Right. Many 'emergencies' have a cheaper interim answer that removes the need to borrow at all.", incorrect: "Look for the interim solution first. A longer term or a second loan makes the position worse." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cdx-lt-ra-sc", step: { type: "scenario", question: "Nomsa's quote shows a rate she recognises but a total cost higher than she calculated. Where does she look?", options: ["The cost-of-credit disclosure", "The quoted interest rate alone", "Her latest bank statement", "Her full credit report"], correct: 0, feedback: { correct: "Right. Those additions explain the gap, and they're required to be itemised before she signs.", incorrect: "The cost-of-credit section itemises the fees and insurance that sit on top of the rate." } } },
    ],
  },
];
