...
const bcSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "cbx-bc-tr-mcq", step: { type: "mcq", question: "What makes blockchain records so difficult to tamper with?", options: ["Each block is cryptographically linked to the one before, and thousands of computers hold copies", "A single company guards the database", "The data is encrypted so nobody can read it", "Transactions are deleted after a year"], correct: 0, feedback: { correct: "Right. Change one block and every block after it breaks, and you'd have to convince the majority of the network to accept your version.", incorrect: "It's the chaining plus distribution. There's no single database to attack, and altered history is immediately visible." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cbx-bc-ws-sc", step: { type: "scenario", question: "Sipho wants to send R500 to a friend in Johannesburg. Is crypto the sensible tool?", options: ["No. A local instant payment is faster, cheaper and reversible if something goes wrong", "Yes, always", "Yes, if the amount is small", "Only on weekends"], correct: 0, feedback: { correct: "Right. Crypto's advantage is cross-border and trustless settlement, not domestic payments between people who already trust each other.", incorrect: "Local instant payments win here. Crypto solves a problem he doesn't have." } } },
    ],
  },
  {
...
const btcSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "cbx-be-sc-sc", step: { type: "scenario", question: "Someone argues Bitcoin 'must' rise because supply is capped. What's missing from that argument?", options: ["Demand. Price needs buyers, and interest can fall as well as rise", "The transaction fee", "The mining difficulty", "The exchange listing"], correct: 0, feedback: { correct: "Right. Fixed supply says nothing about how many people want it next year.", incorrect: "Demand is the missing half. Supply constraints only matter if buyers keep showing up." } } },
    ],
  },
  {
...
const exSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "cbx-ex-lc-sc", step: { type: "scenario", question: "An offshore platform offers better prices but isn't FSCA-licensed. What are you giving up?", options: ["Local recourse, FICA protections and any realistic route to complain", "Nothing meaningful", "Only the user interface", "Tax reporting only"], correct: 0, feedback: { correct: "Right. If an unlicensed offshore platform freezes withdrawals, there's very little a South African can do about it.", incorrect: "You give up local oversight and recourse. That's usually worth more than a small price difference." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "cbx-ex-cu-mcq", step: { type: "mcq", question: "What does 'not your keys, not your coins' mean?", options: ["Crypto held on an exchange is legally a claim against that exchange, not a holding you control", "Exchanges charge for key storage", "You need a password to trade", "Keys expire after a year"], correct: 0, feedback: { correct: "Right. Control of the private key is what constitutes ownership on a blockchain.", incorrect: "It means custody equals control. Coins on an exchange are the exchange's, with you as a creditor." } } },
      { variantId: "cbx-ex-cu-sc", step: { type: "scenario", question: "Johan holds a long-term crypto position on an exchange. What's the trade-off in moving it to self-custody?", options: ["He removes exchange failure risk but takes on full responsibility for the keys", "There's no trade-off", "He loses the ability to sell", "It becomes tax-free"], correct: 0, feedback: { correct: "Right, and self-custody has its own failure mode: lose the seed phrase and the coins are gone permanently.", incorrect: "He trades counterparty risk for key-management risk. Both are real; neither is free." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "crypto-custody",
    variants: [
      { variantId: "cbx-ex-co-mcq", step: { type: "mcq", question: "Where do crypto trading costs usually hide?", options: ["In the spread between buy and sell prices, on top of the visible fee", "In the blockchain itself", "In your bank charges only", "There are no hidden costs"], correct: 0, feedback: { correct: "Right. A wide spread can cost more than the advertised commission, especially on smaller or less liquid coins.", incorrect: "The spread. Compare the actual buy and sell prices, not just the stated fee." } } },
...
const ctaxSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "cbx-ct-sw-sc", step: { type: "scenario", question: "Ayesha made 200 swaps this year and kept no records. What's her position?", options: ["She must still calculate and declare each disposal in rands. Reconstructing it will be painful", "Nothing is owed since she never cashed out to rands", "Only her final balance matters", "SARS ignores swaps"], correct: 0, feedback: { correct: "Right. Exchanges report to SARS, and 'I didn't keep records' isn't a defence, export the history and reconstruct it.", incorrect: "Each swap is a disposal requiring a rand value. Never cashing out doesn't remove the obligation." } } },
    ],
  },
  {
