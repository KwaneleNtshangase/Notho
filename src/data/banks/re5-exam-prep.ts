...
const l1PurposeSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-pur-wd-mcq", step: { type: "mcq", question: "What does the FAIS Act primarily regulate?", options: ["Adviser conduct", "The performance of the products", "Interest rates on loans", "Only the banking sector"], correct: 0, feedback: { correct: "Right. FAIS is market-conduct law, it governs how services are rendered, not product returns.", incorrect: "FAIS regulates conduct, how advice and intermediary services are given, not product performance or pricing." } } },
  ...
  },
  {
    ...
    conceptId: "fais-purpose",
    variants: [
      { variantId: "re5-pur-aim-mcq", step: { type: "mcq", question: "Which is a core aim of FAIS?", options: ["Suitable advice", "Guarantee investment growth", "Fix the product prices", "Ban commission entirely"], correct: 0, feedback: { correct: "Right. Professionalise the industry, ensure suitability and disclosure, and provide the Ombud.", incorrect: "FAIS aims for suitable advice, disclosure and a complaints avenue, not guaranteed growth or fixed prices." } } },
...
const l2DefinitionsSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-def-adv-mcq", step: { type: "mcq", question: "What makes something 'advice' under FAIS?", options: ["A recommendation or proposal", "Any mention of a product at all", "Only a completed sale", "Reading a brochure aloud"], correct: 0, feedback: { correct: "Right. The line is the recommendation/guidance/proposal.", incorrect: "Advice needs a recommendation, guidance or proposal, not just any product mention." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-def-int-mcq2", step: { type: "mcq", question: "An 'intermediary service' is defined as any act, OTHER than advice, that is:", options: ["Done to buy or maintain a product", "A recommendation to buy something", "A guarantee of returns", "A tax calculation for them"], correct: 0, feedback: { correct: "Right. It's a client-facing act (not advice) aimed at concluding or maintaining a product.", incorrect: "It's an act other than advice, done for the client to buy or maintain a product." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-def-rol-mcq2", step: { type: "mcq", question: "The 'FSP' in FAIS refers to:", options: ["The licensed business itself", "The client who is being advised", "The regulator, the FSCA", "The Ombud's office"], correct: 0, feedback: { correct: "Right. The FSP is the licensed provider business.", incorrect: "The FSP is the licensed business. The FSCA is the regulator; the Ombud resolves complaints." } } },
    ],
  },
  {
...
const l3CategoriesSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "fsp-categories",
    variants: [
      { variantId: "re5-cat-c2-mcq", step: { type: "mcq", question: "An FSP makes buy/sell decisions on a client's portfolio without approving each trade. Which category?", options: ["Category II", "Category I", "Category III", "Category IV"], correct: 0, feedback: { correct: "Right. Investment discretion on the client's behalf is Category II.", incorrect: "It's Category II (discretionary). Category I is advice/intermediary services only." } } },
      ...
      { variantId: "re5-cat-c2-mcq2", step: { type: "mcq", question: "Category III FSPs are:", options: ["Administrative FSPs", "Hedge fund managers only", "Assistance business FSPs", "Ordinary financial advisers"], correct: 0, feedback: { correct: "Right. Category III = administrative FSPs (LISPs). IIA = hedge funds; IV = assistance business; I = advisers.", incorrect: "Category III is administrative (LISPs). Hedge funds are IIA, assistance business IV, advisers I." } } },
    ],
  },
  {
...
const l4SuspendSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-sus-gr-mcq", step: { type: "mcq", question: "Which is a ground for the FSCA to suspend or withdraw a licence?", options: ["It's no longer fit and proper", "The FSP earned high profits", "A client changed advisers", "The FSP hired new staff"], correct: 0, feedback: { correct: "Right. Losing fit & proper, fraud, non-rendering, or serious breaches are grounds.", incorrect: "Grounds include failing fit & proper, fraud, or serious contraventions, not profit or ordinary staffing." } } },
...
const l5RolesSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-rol-rg-mcq", step: { type: "mcq", question: "What must every FSP maintain about its representatives and KIs?", options: ["An up-to-date register of both", "Nothing in particular is required", "Only their salaries", "Only a phone list"], correct: 0, feedback: { correct: "Right. The register records categories/subcategories and whether they work under supervision.", incorrect: "An up-to-date register of reps and KIs (with categories and supervision status) is required." } } },
      ...
      { variantId: "re5-rol-rg-mcq2", step: { type: "mcq", question: "The register must record, for each representative:", options: ["Categories and supervision status", "Their home address and nothing else", "Their favourite products", "Their commission targets"], correct: 0, feedback: { correct: "Right. Authorised scope and supervision status are the key entries.", incorrect: "It records authorised categories/subcategories and supervision status." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-rol-su-sc", step: { type: "scenario", question: "An FSP lets a brand-new rep advise clients alone, unsupervised, before they've passed any exam. Is this compliant?", options: ["No, supervision applies", "Yes, the FSP is licensed", "Yes, if the client agrees", "Yes, for the first full year"], correct: 0, feedback: { correct: "Right. Until competent, they must be supervised.", incorrect: "No. A not-yet-competent rep must be supervised, not left to advise alone." } } },
    ],
  },
];
...
const l6DebarmentSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-deb-wh-mcq", step: { type: "mcq", question: "What is 'debarment'?", options: ["Losing the right to advise", "A fine paid to the client directly", "A tax levied on all advisers", "A special type of licence"], correct: 0, feedback: { correct: "Right. It bars the person from rendering financial services.", incorrect: "Debarment removes the ability to render financial services." } } },
  ...
  },
  {
    ...
    conceptId: "fais-debarment",
    variants: [
      { variantId: "re5-deb-fp-sc", step: { type: "scenario", question: "An FSP wants to debar a rep quietly, by removing them from the register without telling them. Allowed?", options: ["No, notice and reasons apply", "Yes, the FSP owns its register", "Yes, if the FSCA is told after", "Yes, if the rep has resigned"], correct: 0, feedback: { correct: "Right. A fair process is mandatory before debarment takes effect.", incorrect: "No. Notice, reasons and a chance to respond are required, no secret debarment." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-deb-rc-sc", step: { type: "scenario", question: "After debarring someone, the FSP refuses to explain why or allow any challenge. What's wrong?", options: ["Reasons and a right to respond", "Nothing at all, silence is fine", "The FSP must pay a fine", "The client decides it"], correct: 0, feedback: { correct: "Right. Reasons and a route to challenge are essential to fairness.", incorrect: "Fairness requires reasons and a reconsideration/appeal right, silence isn't acceptable." } } },
    ],
  },
];
...
const l7PillarsSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "fit-and-proper",
    variants: [
      { variantId: "re5-pil-ho-mcq", step: { type: "mcq", question: "Which could cause someone to FAIL the honesty & integrity test?", options: ["A dishonesty conviction", "Passing the RE5 exam well", "Completing your CPD on time", "Having a great many clients"], correct: 0, feedback: { correct: "Right. Dishonesty offences, prior debarment, or lying on an application can all fail this test.", incorrect: "A dishonesty conviction (among others) fails honesty & integrity. The others are positives." } } },
  ...
  },
  {
    ...
    conceptId: "fit-and-proper",
    variants: [
      { variantId: "re5-pil-cp-mcq", step: { type: "mcq", question: "The 'competence' pillar covers:", options: ["Qualifications and exams", "Only how many clients you have", "Your monthly commission target", "The size of your office"], correct: 0, feedback: { correct: "Right. Competence = qualifications, RE, experience, class-of-business/product training.", incorrect: "Competence covers qualifications, exams, experience and training, not client counts." } } },
      ...
      { variantId: "re5-pil-cp-mcq2", step: { type: "mcq", question: "'Operational ability' as a pillar refers to:", options: ["Resources, systems and governance", "Guaranteeing the client's returns", "Charging the lowest fees", "Being the largest FSP around"], correct: 0, feedback: { correct: "Right. It's about the capacity/systems to operate compliantly.", incorrect: "Operational ability is about resources and systems to render services properly." } } },
    ],
  },
  {
    ...
    conceptId: "fit-and-proper",
    variants: [
      { variantId: "re5-pil-cq-mcq", step: { type: "mcq", question: "Failing a fit & proper requirement can trigger:", options: ["Debarment or licence action", "A bonus", "A guaranteed client", "Nothing"], correct: 0, feedback: { correct: "Right. It has real consequences, debarment or licence action.", incorrect: "Failing fit & proper can lead to debarment or licence action." } } },
...
const l8CompetenceSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "re5-com-ql-mcq2", step: { type: "mcq", question: "Before rendering advice on a product, a representative must also complete:", options: ["Class-of-business training", "A general marketing course", "A personal tax return", "An estate plan for clients"], correct: 0, feedback: { correct: "Right. Class-of-business and product-specific training are required first.", incorrect: "Class-of-business and product-specific training must be done before advising on that product." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "fais-competence-cpd",
    variants: [
      { variantId: "re5-com-pc-sc", step: { type: "scenario", question: "A rep argues the insurer's product-specific training should count toward their CPD hours. Correct?", options: ["No, it's separate from CPD", "Yes, all training counts", "Yes, but only half of it", "Only if the insurer is an FSP"], correct: 0, feedback: { correct: "Right. Product and class-of-business training are distinct from CPD.", incorrect: "No. Product-specific training is its own requirement; it doesn't count as CPD." } } },
  ...
  },
  {
    ...
    conceptId: "fais-competence-cpd",
    variants: [
      { variantId: "re5-com-sv-mcq", step: { type: "mcq", question: "Until a new representative meets the competency requirements, they must:", options: ["Work under supervision", "Stop doing all work entirely", "Advise only wealthy clients", "Get a signed client waiver"], correct: 0, feedback: { correct: "Right. Supervision bridges the gap until requirements are met.", incorrect: "They work under supervision until competent, not a full stop, nor a waiver." } } },
...
const l9GeneralDutySlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-gd-st-mcq", step: { type: "mcq", question: "The General Code's overarching standard is to render services:", options: ["Honestly, fairly", "As profitably as possible", "Favouring the product supplier", "With minimal disclosure"], correct: 0, feedback: { correct: "Right. That's the lens for every specific Code rule.", incorrect: "The standard is honest, fair, skilled, careful, diligent service in clients' interests." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-gd-ba-mcq2", step: { type: "mcq", question: "Which behaviour complies with the General Code?", options: ["Balanced information", "Overstating the benefits", "Concealing the real risks", "Pressuring the client to sign"], correct: 0, feedback: { correct: "Right. Correct, clear, timely, balanced. That's the standard.", incorrect: "Only correct, clear, timely and balanced disclosure complies; the others breach the Code." } } },
    ],
  },
];
...
const l10DisclosuresSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "re5-dis-tb-mcq2", step: { type: "mcq", question: "Product disclosure must cover:", options: ["Terms, fees, charges and risks", "Only the product name", "Only the benefits", "Nothing needs to be in writing"], correct: 0, feedback: { correct: "Right. Full material terms, costs and risks, plus the provider's remuneration.", incorrect: "Product disclosure covers terms, fees, penalties and material risks (and the provider's remuneration)." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-dis-rm-mcq", step: { type: "mcq", question: "A fee negotiated with the client must be:", options: ["Agreed in writing", "Kept secret from the client", "Fixed by the FSCA itself", "Paid in full before any advice"], correct: 0, feedback: { correct: "Right. Negotiated fees are agreed in writing and stoppable by the client.", incorrect: "A negotiated fee must be agreed in writing, and the client must be able to stop it." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-dis-ow-mcq", step: { type: "mcq", question: "Product-supplier disclosure includes:", options: ["Name, contact and the relationship", "Only the supplier's company logo", "The client's tax number", "The Ombud's annual budget"], correct: 0, feedback: { correct: "Right. Identity, contact, relationship and any conditions/restrictions.", incorrect: "It covers the supplier's identity, contact, relationship and any restrictions." } } },
...
const l11SuitabilitySlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-sui-na-mcq", step: { type: "mcq", question: "Before giving advice, a provider must:", options: ["A needs analysis", "Guarantee the client's returns", "Pick the highest-commission product", "Skip straight to the sale itself"], correct: 0, feedback: { correct: "Right. Gather the client's situation, needs, objectives and risk profile first.", incorrect: "A needs and suitability analysis comes first. Advice must fit the client." } } },
  ...
  },
  {
    ...
    conceptId: "code-suitability",
    variants: [
      { variantId: "re5-sui-ra-mcq", step: { type: "mcq", question: "A record of advice must reflect:", options: ["Needs, options and the reasoning", "Only the product name", "The adviser's own commission target", "Nothing specific at all"], correct: 0, feedback: { correct: "Right. Needs, options considered, and the basis for the recommendation.", incorrect: "It records needs/objectives, options considered, and why the product suits the client." } } },
      ...
      { variantId: "re5-sui-ra-sc", step: { type: "scenario", question: "An adviser recommends a fund but keeps no record of why it suits the client. What's the problem?", options: ["A record of advice is required", "Nothing, records are optional", "Only the client keeps records", "It's fine if the client is happy"], correct: 0, feedback: { correct: "Right. A record of advice is mandatory.", incorrect: "A record of advice, showing why the product suits the client, is required." } } },
    ],
  },
  {
    ...
    conceptId: "code-suitability",
    variants: [
      { variantId: "re5-sui-aa-sc", step: { type: "scenario", question: "After warnings, a conservative client insists on a high-risk product. The provider must:", options: ["Proceed, recording the warnings", "Falsify the risk profile to fit", "Refuse, the Code bans it outright", "Proceed silently and say nothing"], correct: 0, feedback: { correct: "Right. Record the mismatch, the warning and the client's instruction.", incorrect: "Record the instruction and warnings. Never falsify the profile, and it's not outright banned." } } },
      ...
      { variantId: "re5-sui-aa-mcq", step: { type: "mcq", question: "When a client acts against advice, the key protection for everyone is to:", options: ["Document the instruction given", "Delete the client file entirely", "Say nothing about it", "Cancel the client entirely"], correct: 0, feedback: { correct: "Right. A clear record of the warned-against instruction protects client and adviser.", incorrect: "Document the instruction and the disclosed risks. That's the safeguard." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-sui-ls-mcq", step: { type: "mcq", question: "Limited-scope advice requires the provider to:", options: ["Warn of the limits", "Guarantee it is complete", "Skip the record of advice", "Charge the client extra for it"], correct: 0, feedback: { correct: "Right. Disclose the narrower basis and its risks.", incorrect: "The client must be warned of the limitations and risks of the narrower advice." } } },
      { variantId: "re5-sui-ls-sc", step: { type: "scenario", question: "A provider advises only on one product line at the client's request. What must they make clear?", options: ["That the advice is limited in scope", "That it's a full financial plan", "Nothing", "That returns are guaranteed"], correct: 0, feedback: { correct: "Right. Flag the limited scope and its risks.", incorrect: "They must disclose the limited scope and the risks it creates." } } },
    ],
  },
];
...
const l12RecordsSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-rec-co-mcq2", step: { type: "mcq", question: "A conflict of interest arises when:", options: ["Own interest may sway advice", "The client changes their mind", "The FSP hires new staff", "A product performs well"], correct: 0, feedback: { correct: "Right. Commissions, ownership interests and incentives can all create conflicts.", incorrect: "It's when the provider's interests could sway advice away from the client's interests." } } },
    ],
  },
  {
    ...
    conceptId: "code-records-coi",
    variants: [
      { variantId: "re5-rec-vq-mcq", step: { type: "mcq", question: "Which arrangement is expressly restricted by the conflict-of-interest rules?", options: ["Paying for volume", "Keeping a written COI policy", "Disclosing the commission", "Doing a proper needs analysis"], correct: 0, feedback: { correct: "Right. Rewarding quantity over quality (or steering to a supplier) via a financial interest is restricted.", incorrect: "The restricted arrangement is a financial interest rewarding volume over quality." } } },
      ...
      { variantId: "re5-rec-vq-sc", step: { type: "scenario", question: "A dealer group pays advisers a bonus purely for selling the most of one insurer's product. Concern?", options: ["A restricted volume incentive", "It's fine, more sales is good", "It's required by the Code", "It's a FICA matter only"], correct: 0, feedback: { correct: "Right. Volume/supplier-preference incentives are restricted under COI rules.", incorrect: "It's a restricted conflict arrangement: rewarding volume/supplier preference." } } },
    ],
  },
  {
    ...
    conceptId: "code-records-coi",
    variants: [
      { variantId: "re5-rec-ad-mcq", step: { type: "mcq", question: "Under the Code, advertisements must:", options: ["Not be misleading", "Only show the benefits", "Guarantee the returns", "Hide the provider's identity"], correct: 0, feedback: { correct: "Right. Adverts must be fair, not misleading, with required cautionary information.", incorrect: "Adverts must not mislead or create unrealistic expectations." } } },
      ...
      { variantId: "re5-rec-ad-sc", step: { type: "scenario", question: "An advert promises 'guaranteed 30% returns, no risk'. Problem?", options: ["Misleading and prohibited", "It's fine if it gets clients", "It's required disclosure", "It's a routine FICA report"], correct: 0, feedback: { correct: "Right. Misleading, expectation-inflating adverts breach the Code.", incorrect: "It's misleading and creates unrealistic expectations, prohibited." } } },
    ],
  },
];
...
const l13TcfSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-tcf-oc-mcq", step: { type: "mcq", question: "Treating Customers Fairly (TCF) is best described as:", options: ["An outcomes-based approach", "A single tax rule for firms", "A commission-sharing scheme", "A product guarantee"], correct: 0, feedback: { correct: "Right. TCF sets six fairness outcomes.", incorrect: "TCF is an outcomes-based framework with six outcomes." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-tcf-o6-mcq", step: { type: "mcq", question: "A firm makes it deliberately hard to cancel a policy or lodge a claim. Which TCF outcome does this offend?", options: ["Outcome 6", "Outcome 1 only", "None", "A FICA rule"], correct: 0, feedback: { correct: "Right. Post-sale obstruction offends Outcome 6.", incorrect: "It offends Outcome 6, no unreasonable barriers to switch, claim or complain." } } },
      { variantId: "re5-tcf-o6-sc", step: { type: "scenario", question: "Customers can buy a product online in minutes but must post a notarised letter to cancel. TCF concern?", options: ["Yes. An unreasonable post-sale barrier", "No, cancellation should be hard", "No, it's a FICA issue", "No concern at all"], correct: 0, feedback: { correct: "Right. Asymmetric friction to exit is an Outcome 6 problem.", incorrect: "It's an Outcome 6 concern, an unreasonable barrier to cancelling." } } },
    ],
  },
  {
    ...
    conceptId: "tcf-complaints",
    variants: [
      { variantId: "re5-tcf-ic-mcq", step: { type: "mcq", question: "An FSP's internal complaints procedure must be:", options: ["Documented, accessible and fair", "Verbal and informal in practice", "Hidden from the clients", "Entirely optional to have"], correct: 0, feedback: { correct: "Right. Documented, accessible, fair and prompt: with records kept.", incorrect: "It must be documented, accessible and resolve complaints fairly and promptly." } } },
      ...
      { variantId: "re5-tcf-ic-sc", step: { type: "scenario", question: "A client isn't satisfied after the FSP's internal process. The FSP must:", options: ["Tell them about the FAIS Ombud", "Close the file silently and move on", "Refuse any further contact at all", "Report the client straight to SARS"], correct: 0, feedback: { correct: "Right. Inform the client how to escalate to the Ombud.", incorrect: "The FSP must tell the client of their right to go to the FAIS Ombud." } } },
    ],
  },
  {
...
const l14OmbudSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "re5-omb-wh-mcq", step: { type: "mcq", question: "What can the FAIS Ombud do?", options: ["Make a binding determination", "Set the national interest rates", "Issue FSP licences", "Collect tax from FSPs"], correct: 0, feedback: { correct: "Right. The Ombud resolves complaints; determinations bind like a court order.", incorrect: "The Ombud investigates, mediates and makes binding determinations, it doesn't license or tax." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-omb-pr-mcq2", step: { type: "mcq", question: "The three-year period runs from when the client:", options: ["When they became aware", "When they first met the adviser", "When they signed any document", "When they paid the first premium"], correct: 0, feedback: { correct: "Right. Awareness (actual or constructive) of the facts starts the clock.", incorrect: "It runs from when the client became (or should have become) aware of the facts." } } },
    ],
  },
];
...
const l15FicaSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "fica",
    variants: [
      { variantId: "re5-fic-rq-mcq", step: { type: "mcq", question: "As an 'accountable institution' under FICA, an FSP must:", options: ["CDD, an RMCP and reporting", "Guarantee the client's returns fully", "Set the market interest rates", "Ignore suspicious transactions"], correct: 0, feedback: { correct: "Right. CDD/KYC, RMCP, reporting and record-keeping are core FICA duties.", incorrect: "FICA requires CDD, an RMCP, reporting to the FIC and record-keeping." } } },
      ...
      { variantId: "re5-fic-rq-mcq2", step: { type: "mcq", question: "'Customer due diligence' (CDD/KYC) means:", options: ["Identifying and verifying clients", "Guaranteeing their returns", "Setting their tax", "Choosing their products"], correct: 0, feedback: { correct: "Right. Identify and verify the client and beneficial owners.", incorrect: "CDD is identifying and verifying clients and their beneficial owners." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-fic-to-mcq", step: { type: "mcq", question: "'Tipping off' means:", options: ["Telling a client about an STR", "Giving a client a large discount", "Reporting to the FIC", "Doing customer due diligence"], correct: 0, feedback: { correct: "Right. Warning the client about a report is tipping off, prohibited.", incorrect: "Tipping off is alerting the client to an STR: a criminal offence." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-fic-rc-mcq", step: { type: "mcq", question: "FICA records are generally kept from:", options: ["Five years from the end", "Only one week", "Forever, without exception", "Until the client asks"], correct: 0, feedback: { correct: "Right. Five years from the end of the relationship or the transaction date.", incorrect: "Generally five years from the end of the relationship or the transaction." } } },
...
const quizFitProperSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "re5-qfp-pl-mcq2", step: { type: "mcq", question: "Competence includes:", options: ["Qualifications and exams", "Only the monthly sales targets", "The location of your office", "The client count"], correct: 0, feedback: { correct: "Right. Qualifications, RE, experience and training.", incorrect: "Competence is qualifications, exams, experience and training." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-qfp-rc-mcq2", step: { type: "mcq", question: "A COI management policy must address how the FSP will:", options: ["Identify and disclose", "Maximise the commission earned", "Hide conflicts from clients", "Pay representatives for volume"], correct: 0, feedback: { correct: "Identify, avoid/mitigate and disclose.", incorrect: "It must identify, avoid/mitigate and disclose conflicts." } } },
...
const quizOmbudFicaSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "re5-qof-om-mcq2", step: { type: "mcq", question: "The Ombud may DECLINE a complaint that is:", options: ["Older than three years", "Worth more than R50 000", "Only about 18 months old", "Unresolved after six weeks"], correct: 0, feedback: { correct: "Right. Three-year prescription.", incorrect: "It may decline matters older than three years." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "re5-qof-sw-sc", step: { type: "scenario", question: "The FSP hasn't resolved a written complaint after 8 weeks. The client may:", options: ["Refer it to the FAIS Ombud now", "Wait a full year before doing anything", "Go straight to the High Court only", "Do nothing, it has already lapsed"], correct: 0, feedback: { correct: "Right. The six weeks has lapsed, so escalate to the Ombud.", incorrect: "They may now go to the Ombud. The FSP's six weeks has passed." } } },
    ],
  },
  {
    ...
    conceptId: "fica",
    variants: [
      { variantId: "re5-qof-st-mcq", step: { type: "mcq", question: "Suspecting a client's funds are proceeds of crime, an FSP must:", options: ["File a suspicious transaction report with the FIC", "Warn the client first", "Report to the FSCA instead", "Delete the records"], correct: 0, feedback: { correct: "File an STR with the FIC; don't tip off.", incorrect: "You must file an STR with the FIC and not tip off the client." } } },
  ...
  },
  {
    ...
    conceptId: "tcf-complaints",
    variants: [
      { variantId: "re5-qof-tc-mcq", step: { type: "mcq", question: "TCF Outcome 6 concerns:", options: ["No post-sale barriers", "Guaranteed client returns", "Maximum commission earned", "Fewer complaints on record"], correct: 0, feedback: { correct: "Right. Outcome 6 = no unreasonable post-sale barriers.", incorrect: "It's Outcome 6: removing unreasonable post-sale barriers." } } },
      ...
      { variantId: "re5-qof-tc-mcq2", step: { type: "mcq", question: "TCF is best described as:", options: ["An outcomes-based fairness framework", "A tax", "A commission rule", "A product guarantee"], correct: 0, feedback: { correct: "Right. Six fairness outcomes.", incorrect: "TCF is an outcomes-based framework with six outcomes." } } },
    ],
  },
];
