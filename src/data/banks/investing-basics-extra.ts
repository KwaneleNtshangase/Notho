...
const etfSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "etf",
    variants: [
      { variantId: "ibx-et-id-mcq", step: { type: "mcq", question: "What does a single global-index ETF buy you in one transaction?", options: ["A slice of roughly 1 500 companies across the world's developed markets", "Shares in one carefully chosen company", "A guaranteed annual return", "A fixed-interest deposit"], correct: 0, feedback: { correct: "Right. One debit order spreads your money across thousands of businesses in dozens of countries. Diversification that used to need millions.", incorrect: "It's broad exposure: a global index ETF holds around 1 500 companies across developed markets in a single instrument." } } },
  ...
  },
  {
    ...
    conceptId: "etf",
    variants: [
      { variantId: "ibx-et-tk-mcq", step: { type: "mcq", question: "What is an index ETF actually trying to do?", options: ["Match the index's return as closely as possible, minus a small fee", "Beat the index every year", "Guarantee capital", "Time the market"], correct: 0, feedback: { correct: "Right, and matching is a higher bar than it sounds, most active funds fail to beat their index over long periods.", incorrect: "It tracks rather than beats. That's the design, and over decades it outperforms most attempts to do better." } } },
  ...
  },
  {
    ...
    conceptId: "etf",
    variants: [
      { variantId: "ibx-et-ch-mcq", step: { type: "mcq", question: "What should you check before choosing between two similar index ETFs?", options: ["The TER, the index tracked, and how it handles dividends", "Last year's return only", "Which one has the shortest name", "Which one your bank promotes"], correct: 0, feedback: { correct: "Right. Two funds tracking the same index differ mainly on cost and structure. Last year's return tells you almost nothing about next year's.", incorrect: "Compare cost, the underlying index and dividend treatment. Recent performance is the weakest signal." } } },
...
const utSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "ibx-ut-wt-mcq", step: { type: "mcq", question: "What is a unit trust?", options: ["A pooled fund where many investors' money is managed together under one mandate", "A loan to a company", "A savings account with a fixed rate", "A property ownership scheme"], correct: 0, feedback: { correct: "Right. You buy units in the pool, and their value moves with the underlying holdings.", incorrect: "It's a pooled investment: many investors' money managed collectively against a stated mandate." } } },
  ...
  },
  {
    ...
    conceptId: "unit-trusts",
    variants: [
      { variantId: "ibx-ut-ap-mcq", step: { type: "mcq", question: "What's the stated case for an actively managed unit trust over an index fund?", options: ["A manager can in principle avoid weak companies and beat the index", "It's always cheaper", "Returns are guaranteed", "It's the only option available in SA"], correct: 0, feedback: { correct: "Right. That's the promise. The evidence is that most active funds fail to beat their index after fees over long periods.", incorrect: "The claim is skill-based outperformance. Whether it happens after fees is the real question." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-ut-sl-sc", step: { type: "scenario", question: "Priya's fund has lagged its index for three years while charging 1.9%. What's worth doing?", options: ["Review whether the mandate still fits and compare a low-cost alternative", "Wait another five years", "Add more money to average down", "Switch to whichever fund led last year"], correct: 0, feedback: { correct: "Right. Three years of lagging while paying a premium fee justifies a review, but move to a considered alternative, not last year's winner.", incorrect: "Review it properly. Doing nothing and chasing the latest winner are both poor responses." } } },
    ],
  },
  {
...
const dcaSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "ibx-dc-wi-mcq", step: { type: "mcq", question: "What does investing a fixed amount every month actually achieve?", options: ["You buy more units when prices are low and fewer when high, averaging your entry price", "You always beat the market", "You avoid all losses", "You lock in a fixed return"], correct: 0, feedback: { correct: "Right, and the bigger benefit is behavioural: the decision is made once, so you're not guessing about timing every month.", incorrect: "It averages your buy price and removes the timing decision. It doesn't guarantee gains." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-dc-vl-mcq", step: { type: "mcq", question: "Why might someone still phase a lump sum in over several months?", options: ["It reduces the risk of investing everything just before a fall, and makes the decision easier to live with", "It guarantees a higher return", "It avoids capital gains tax", "It's legally required for amounts over R100 000"], correct: 0, feedback: { correct: "Right. It's a behavioural trade: slightly lower expected return for a much lower chance of abandoning the plan.", incorrect: "It manages regret and timing risk. There's no tax or legal advantage." } } },
  ...
  },
  {
    ...
    conceptId: "dollar-cost-averaging",
    variants: [
      { variantId: "ibx-dc-md-sc", step: { type: "scenario", question: "The JSE drops 30% in month four of your R2 000-a-month ETF plan. What's the right move?", options: ["Keep the debit order running. You're now buying the same units cheaper", "Stop the debit order until markets recover", "Sell everything to prevent further losses", "Switch to a fund that went up last month"], correct: 0, feedback: { correct: "Right. A fall early in a long plan is helpful: your R2 000 buys more units, and those units recover with the market.", incorrect: "Keep buying. Stopping during a fall means missing the cheapest purchases of your entire plan." } } },
      { variantId: "ibx-dc-md-mcq", step: { type: "mcq", question: "For someone still contributing monthly, a market fall is:", options: ["An opportunity to buy the same investments at lower prices", "A reason to stop investing", "A signal to switch to cash", "Proof the strategy failed"], correct: 0, feedback: { correct: "Right. You only lose money in a fall if you sell. A contributor is buying, not selling.", incorrect: "It's a discount for a buyer. Falls only hurt people who are withdrawing or who panic-sell." } } },
...
const scamSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "ibx-sc-ir-mcq", step: { type: "mcq", question: "A WhatsApp contact promises 30% monthly returns from forex trading. Most likely explanation?", options: ["It's a Ponzi scheme paying early investors with later investors' money", "An unusually skilled trader", "A legitimate high-risk product", "A promotional rate for new clients"], correct: 0, feedback: { correct: "Right. 30% a month is 2 300% a year: no legitimate strategy produces that, and the pitch arriving on WhatsApp is the second red flag.", incorrect: "That return is impossible to sustain. It's the classic Ponzi signature: guaranteed high returns, delivered socially." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-sc-fc-mcq", step: { type: "mcq", question: "What's the value of checking the FSCA register before investing?", options: ["It confirms the provider is authorised and gives you recourse if they misconduct", "It confirms the returns are achievable", "It insures your capital", "It fixes the fees"], correct: 0, feedback: { correct: "Right, and if they're not on the register that's the end of the conversation. No licence means no complaints route.", incorrect: "It establishes authorisation and recourse. It doesn't validate returns or protect capital." } } },
      { variantId: "ibx-sc-fc-sc", step: { type: "scenario", question: "A slick operator gives Ayesha an FSP number. What should she do with it?", options: ["Verify it on the FSCA register and check the categories they're authorised for", "Accept it as proof of legitimacy", "Ignore it. Numbers can't be checked", "Ask the operator to confirm it in writing"], correct: 0, feedback: { correct: "Right. Cloned and borrowed FSP numbers are common, and the register also shows what advice they're actually licensed to give.", incorrect: "Verify it independently on the FSCA register. Quoting a number proves nothing on its own." } } },
    ],
  },
  {
    ...
    variants: [
      { variantId: "ibx-sc-rf-mcq", step: { type: "mcq", question: "Which combination is the strongest warning sign of an investment scam?", options: ["Guaranteed high returns, urgency to act, and rewards for recruiting others", "A long track record and audited statements", "Clear fee disclosure", "A registered FSP number that checks out"], correct: 0, feedback: { correct: "Right. Any one of those is concerning; together they're conclusive.", incorrect: "Guarantees, urgency and recruitment together are the classic signature." } } },
      ...
      { variantId: "ibx-sc-rf-sc", step: { type: "scenario", question: "Johan is told the 'opportunity closes tonight' and he must not discuss it with anyone. What does that tell him?", options: ["Both secrecy and urgency are designed to prevent scrutiny. Walk away", "It's an exclusive offer worth taking", "He should invest a small amount to test it", "He should ask for the deadline in writing"], correct: 0, feedback: { correct: "Right. Secrecy plus a deadline is the scam's core mechanic. Even a small 'test' amount funds the machine and builds trust for a bigger ask.", incorrect: "Walk away. Those two features exist only to stop you getting a second opinion." } } },
    ],
  },
  {
    ...
    variants: [
      { variantId: "ibx-sc-rc-mcq", step: { type: "mcq", question: "You realise you've been scammed. What's the first step?", options: ["Stop all payments, gather every record, and report to your bank and the FSCA or police", "Send more money to unlock the withdrawal", "Wait quietly to see if funds arrive", "Delete the messages out of embarrassment"], correct: 0, feedback: { correct: "Right, and keep the evidence. Messages, statements and account details are what any investigation depends on.", incorrect: "Stop paying, preserve evidence, report. Never delete the record. It's the only chance of any recovery." } } },
...
const propSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-pr-np-mcq", step: { type: "mcq", question: "Which cost most often surprises first-time buy-to-let investors?", options: ["Vacancy months, when the bond still has to be paid", "The transfer duty", "The deposit", "The bond application fee"], correct: 0, feedback: { correct: "Right. Two vacant months a year wipes out a sixth of the rental income while every expense continues.", incorrect: "Vacancies. Everything else is a one-off; empty months recur and hit hardest." } } },
  ...
  },
  {
    ...
    conceptId: "reits",
    variants: [
      { variantId: "ibx-pr-tc-mcq", step: { type: "mcq", question: "Which costs must come off gross rent before you know what a property really earns?", options: ["Rates, levies, insurance, maintenance, agent fees and vacancy", "Only the bond repayment", "Only maintenance", "Nothing. Rent is profit"], correct: 0, feedback: { correct: "Right. An 8% gross yield often becomes 4–5% net, which changes the comparison with other investments completely.", incorrect: "All of them. Gross yield flatters property because it ignores every running cost." } } },
...
const feeSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-fe-fp-mcq", step: { type: "mcq", question: "Why do percentage-based fees become expensive as your portfolio grows?", options: ["The fee grows with your balance even though the work usually doesn't", "The percentage rate increases automatically", "They attract additional tax", "They compound monthly instead of annually"], correct: 0, feedback: { correct: "Right. Advising on R3 million isn't three times the work of advising on R1 million, but a percentage fee charges as if it is.", incorrect: "The rate stays the same; the base grows. That's why large portfolios often move to flat fees." } } },
...
const bondSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "bonds",
    variants: [
      { variantId: "ibx-bd-wb-mcq", step: { type: "mcq", question: "When you buy a government bond, what have you actually done?", options: ["Lent money to the government in exchange for regular interest and your capital back at maturity", "Bought a share of the government's assets", "Made a tax-deductible donation", "Bought foreign currency"], correct: 0, feedback: { correct: "Right. A bondholder is a lender, not an owner, which is why bonds pay a set income rather than sharing in growth.", incorrect: "You've made a loan. Interest along the way, capital returned at maturity." } } },
  ...
  },
  {
    ...
    conceptId: "bonds",
    variants: [
      { variantId: "ibx-bd-rp-mcq", step: { type: "mcq", question: "What job do bonds do in a portfolio?", options: ["Provide steadier income and dampen the swings from equities", "Deliver the highest long-run growth", "Guarantee inflation-beating returns", "Eliminate all risk"], correct: 0, feedback: { correct: "Right. They're the ballast. You give up some growth for a smoother ride and reliable income.", incorrect: "Stability and income, not maximum growth. Equities do the heavy lifting on returns over long periods." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-bd-cr-sc", step: { type: "scenario", question: "A platform offers Sipho 22% a year on 'corporate bonds' from a company he's never heard of. What's his read?", options: ["That yield implies severe credit risk or an outright scam, investigate before anything else", "It's an attractive opportunity", "It's safe because bonds are safe", "It's normal for private companies"], correct: 0, feedback: { correct: "Right. When government paper pays a fraction of that, 22% is either desperation or fiction. Check the FSCA register first.", incorrect: "That yield is a red flag, not an opportunity. The word 'bond' doesn't make an investment safe." } } },
    ],
  },
];
...
const irrSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "ibx-ir-in-sc", step: { type: "scenario", question: "Priya holds a bond fund and rates rise sharply. Her statement shows a loss. Why?", options: ["The fund holds existing bonds whose prices fell as rates rose", "The issuers defaulted", "The fund charged an extra fee", "Her interest payments stopped"], correct: 0, feedback: { correct: "Right. It's a mark-to-market effect, not a credit event, and the fund now reinvests at the higher rates.", incorrect: "It's price movement from the rate rise, not default. Bond funds show this as a capital loss even when every issuer pays." } } },
    ],
  },
  {
    ...
    conceptId: "interest-rate-risk",
    variants: [
      { variantId: "ibx-ir-du-mcq", step: { type: "mcq", question: "What does a bond's duration tell you?", options: ["How sensitive its price is to a change in interest rates", "How long until the issuer defaults", "The interest rate it pays", "Its credit rating"], correct: 0, feedback: { correct: "Right. Longer duration means bigger price swings for the same rate move. That's the risk you're taking for a longer-dated bond.", incorrect: "It measures interest-rate sensitivity, not default risk or the coupon." } } },
      ...
      { variantId: "ibx-ir-du-sc", step: { type: "scenario", question: "Johan needs his capital intact in 18 months. Which bond exposure suits him?", options: ["Short-dated bonds, where price swings from rate moves are small", "Long-dated bonds for the higher yield", "A leveraged bond fund", "Whichever fund performed best last year"], correct: 0, feedback: { correct: "Right. Match the duration to when you need the money. A long bond can be well down in value on the day he needs it.", incorrect: "Short duration. Long bonds swing too much for an 18-month horizon, whatever they yield." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-ir-hm-mcq", step: { type: "mcq", question: "If rates rise after you buy a fixed-rate bond you intend to hold to maturity, what have you actually lost?", options: ["The chance to earn the new higher rate. An opportunity cost, not a capital loss", "Part of your capital, permanently", "Your interest payments", "Nothing at all"], correct: 0, feedback: { correct: "Right. You're locked into the old rate, which is a real cost, but you still receive everything you were promised.", incorrect: "It's opportunity cost. Your capital and coupons are intact; you've just missed the better rate." } } },
      { variantId: "ibx-ir-hm-sc", step: { type: "scenario", question: "Lerato is choosing between a fixed-rate and an inflation-linked retail bond. What's the trade-off?", options: ["Fixed gives a known rate; inflation-linked protects purchasing power if inflation surprises upward", "Inflation-linked always pays more", "Fixed-rate bonds carry no risk", "There's no meaningful difference"], correct: 0, feedback: { correct: "Right. Fixed wins if inflation stays low; inflation-linked wins if it doesn't. It's a choice about which risk you'd rather carry.", incorrect: "It's certainty versus inflation protection. Neither is automatically better. It depends what inflation does." } } },
    ],
  },
  {
...
const thaboSlots: QuestionSlot[] = [
  {
    ...
    conceptId: "tfsa",
    variants: [
      { variantId: "ibx-th-wv-sc", step: { type: "scenario", question: "Thabo is 26, has an emergency fund, no expensive debt, and R500 a month to invest for the long term. What fits best?", options: ["A tax-free savings account holding a low-cost index fund", "A fixed deposit", "A single JSE share he likes", "Cash under the mattress"], correct: 0, feedback: { correct: "Right. Decades of growth with no tax on interest, dividends or capital gains, and R500 a month is far below the R46 000 annual limit.", incorrect: "A TFSA with a low-cost index fund. Long horizon plus tax-free growth is exactly what it's designed for." } } },
      { variantId: "ibx-th-wv-mcq", step: { type: "mcq", question: "What makes a TFSA especially powerful for a young investor?", options: ["Decades of compounding with no tax on growth, dividends or withdrawals", "A guaranteed return", "Employer matching", "It's exempt from all fees"], correct: 0, feedback: { correct: "Right. The longer the money stays in, the larger the tax saving becomes. Time is the ingredient a 26-year-old has most of.", incorrect: "It's the tax-free compounding over a long horizon. Fees still apply and returns aren't guaranteed." } } },
  ...
  },
  {
    ...
    conceptId: "tfsa",
    variants: [
      { variantId: "ibx-th-al-sc", step: { type: "scenario", question: "Thabo invests R500 a month (R6 000 a year). Zanele invests R46 000 a year, about R3 833 a month. Who fills their annual TFSA allowance?", options: ["Zanele. R46 000 is exactly the annual limit", "Thabo", "Both of them", "Neither"], correct: 0, feedback: { correct: "Right. Thabo uses R6 000 of his R46 000. Unused annual room doesn't carry forward, but he's building the habit early, which matters more.", incorrect: "The annual limit is R46 000, so Zanele fills hers exactly and Thabo uses R6 000 of his." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "ibx-th-wr-sc", step: { type: "scenario", question: "Thabo is tempted to use his TFSA for a car deposit in two years. What's the cost?", options: ["He permanently loses that contribution room and decades of tax-free growth", "Nothing. He can replace the money", "A small withdrawal penalty", "SARS taxes the withdrawal"], correct: 0, feedback: { correct: "Right. The withdrawal itself is tax-free, but the room never comes back, so a short-term goal deserves a different account.", incorrect: "The room is gone for good. Save for the car separately and leave the TFSA to compound." } } },
    ],
  },
  {
    ...
    conceptId: "tfsa",
    variants: [
      { variantId: "ibx-th-ss-mcq", step: { type: "mcq", question: "Is R500 a month worth investing at all?", options: ["Yes. The habit and the time in the market matter more than the starting amount", "No, anything under R2 000 is pointless", "Only if he can commit for exactly 30 years", "Only inside a fixed deposit"], correct: 0, feedback: { correct: "Right. Starting at 26 with R500 and escalating with each raise beats starting at 36 with R2 000.", incorrect: "It's absolutely worth it. Starting early with a small amount usually beats starting later with more." } } },
