...
const zbbSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "zero-based-budget",
    variants: [
      { variantId: "mbx-zbb-bd-mcq", step: { type: "mcq", question: "The first step in building a zero-based budget is to:", options: ["Write down your take-home pay", "Start spending and see what's left", "Open up a brand new credit line", "Take a guess at all your expenses"], correct: 0, feedback: { correct: "Right. Start from net income, then allocate down to R0.", incorrect: "Begin with your net take-home pay, then allocate every rand." } } },
  ...
  },
  {
    ...
    conceptId: "zero-based-budget",
    variants: [
      { variantId: "mbx-zbb-su-mcq", step: { type: "mcq", question: "In ZBB, a surplus after your essentials should be:", options: ["Given a job, savings or debt", "Left floating in the account", "Spent freely, it's extra", "Ignored completely"], correct: 0, feedback: { correct: "Right. Even the surplus gets a category, usually savings or extra debt payments.", incorrect: "Assign the surplus to savings or debt. Don't leave it floating." } } },
      ...
      { variantId: "mbx-zbb-su-sc", step: { type: "scenario", question: "Thabo finishes his ZBB with R900 unallocated. What should he do?", options: ["Assign it a job so it hits R0", "Leave it, it'll sort itself out", "Add it to fun without deciding", "Withdraw it and forget it"], correct: 0, feedback: { correct: "Right. Unallocated rands leak. Give the R900 a purpose.", incorrect: "Assign the R900 deliberately. Unallocated money tends to disappear." } } },
    ],
  },
  {
    ...
    conceptId: "zero-based-budget",
    variants: [
      { variantId: "mbx-zbb-wy-mcq", step: { type: "mcq", question: "The main advantage of ZBB over 'spend what's left, save the rest' is:", options: ["Every rand is intentional", "It requires no thinking", "It lets you overspend safely", "It avoids all bills"], correct: 0, feedback: { correct: "Right. Saving first, by design, beats hoping something is left over.", incorrect: "The edge is intentionality: savings are planned, not leftovers." } } },
      ...
      { variantId: "mbx-zbb-wy-sc", step: { type: "scenario", question: "Lerato keeps meaning to save 'whatever's left' but never does. ZBB fixes this by:", options: ["Making savings a fixed allocation", "Removing her savings line entirely", "Letting her spend whatever she likes first", "Adding more monthly subscriptions"], correct: 0, feedback: { correct: "Right. Savings become a non-negotiable line, not a hope.", incorrect: "ZBB makes savings an up-front allocation, so it actually happens." } } },
    ],
  },
];
...
const cashSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mbx-cf-df-mcq", step: { type: "mcq", question: "A doctor earning R180 000/month but spending R185 000/month has:", options: ["Negative cash flow", "Strong cash flow from income", "Rapidly growing net worth", "Nothing to worry about"], correct: 0, feedback: { correct: "Right. −R5 000/month destroys wealth at any income level.", incorrect: "Income minus spending is −R5 000: negative cash flow. High income isn't health." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-cf-im-mcq", step: { type: "mcq", question: "Most people's cash-flow problems are really:", options: ["Spending problems, not income", "Always purely income problems", "Caused only by tax", "Impossible to fix at all"], correct: 0, feedback: { correct: "Right. That's why expense cuts fix cash flow fastest.", incorrect: "They're mostly spending problems, which is good news, because you control spending." } } },
      { variantId: "mbx-cf-im-sc", step: { type: "scenario", question: "Someone with tight cash flow wants more surplus this month. Quickest lever?", options: ["Cut recurring expenses now", "Wait several months for a raise", "Take out a short-term personal loan", "Do absolutely nothing at all"], correct: 0, feedback: { correct: "Right. Trimming recurring costs improves cash flow immediately.", incorrect: "Cutting recurring costs is the immediate lever. A raise is slower and uncertain." } } },
    ],
  },
  {
    ...
    conceptId: "personal-cash-flow",
    variants: [
      { variantId: "mbx-cf-po-mcq", step: { type: "mcq", question: "Why does positive cash flow matter so much?", options: ["The surplus funds saving and investing", "It lets you ignore budgeting entirely", "It guarantees a permanently high income", "It removes all financial risk"], correct: 0, feedback: { correct: "Right. A R3 000/month surplus invested at 10% for 20 years ≈ R2.3m.", incorrect: "Surplus cash flow funds wealth, saving, investing, debt payoff." } } },
      ...
      { variantId: "mbx-cf-po-sc", step: { type: "scenario", question: "Your monthly cash flow is negative. How urgent is it?", options: ["Very, you go backwards every month", "Not urgent, your income will rise", "It only matters near retirement", "Ignore it if you earn a high income"], correct: 0, feedback: { correct: "Right. Negative cash flow is the most pressing thing to fix.", incorrect: "It's urgent: negative cash flow erodes wealth every single month." } } },
    ],
  },
  {
    ...
    conceptId: "personal-cash-flow",
    variants: [
      { variantId: "mbx-cf-di-mcq", step: { type: "mcq", question: "Once you have a monthly surplus, the best habit is to:", options: ["Direct it automatically", "Let it sit and get spent", "Upgrade your lifestyle to match", "Withdraw it all as cash"], correct: 0, feedback: { correct: "Right. Automate the surplus toward a goal before it evaporates.", incorrect: "Direct the surplus on purpose, ideally automatically, or it gets spent." } } },
      ...
      { variantId: "mbx-cf-di-sc", step: { type: "scenario", question: "Sipho finds he has R3 000 surplus each month sitting idle. Best move?", options: ["Automate a transfer on payday", "Leave it and hope to save it later", "Spend it since it is clearly extra", "Move it into a fee-heavy bank account"], correct: 0, feedback: { correct: "Right. Automating it on payday turns surplus into wealth.", incorrect: "Automate the R3 000 to savings/investing. Idle surplus gets spent." } } },
    ],
  },
];
...
const negoSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mbx-neg-wy-mcq", step: { type: "mcq", question: "Why is your starting salary such a big financial lever?", options: ["Raises compound off it", "It's taxed less than other income", "It can't be changed later", "It affects only this year"], correct: 0, feedback: { correct: "Right. A higher base compounds through every future raise.", incorrect: "Your base compounds through raises for decades: it shapes lifetime earnings." } } },
      ...
      { variantId: "mbx-neg-wy-mcq2", step: { type: "mcq", question: "Before negotiating, the most important preparation is to:", options: ["Research the market rate", "Decide the highest number to shout", "Threaten to quit outright", "Nothing at all, just wing it"], correct: 0, feedback: { correct: "Right. Market data (LinkedIn, PayScale, recruiters) anchors a credible ask.", incorrect: "Research the market rate first. Data makes the ask credible." } } },
    ],
  },
  {
  ...
  },
  {
    ...
    conceptId: "salary-negotiation",
    variants: [
      { variantId: "mbx-neg-sr-sc", step: { type: "scenario", question: "You get a R10 000 raise and invest half (R5 000/month) at 10%. After 10 years that's about:", options: ["R1 020 000", "About R600 000", "About R350 000", "About R200 000"], correct: 0, feedback: { correct: "Right: R5 000/month at 10% for 10 years ≈ R1.02m, without cutting your lifestyle.", incorrect: "R5 000/month at 10% for 10 years ≈ R1 million. Save half of every raise." } } },
      ...
      { variantId: "mbx-neg-sr-mcq", step: { type: "mcq", question: "A good rule when a raise arrives is to:", options: ["Bank at least half of it", "Upgrade the car first", "Spend it all, you earned it", "Ignore it completely"], correct: 0, feedback: { correct: "Right. Capturing half turns rising income into rising wealth.", incorrect: "Bank at least half of the raise first. That's how income becomes wealth." } } },
    ],
  },
  {
    ...
    conceptId: "salary-negotiation",
    variants: [
      { variantId: "mbx-neg-sc-mcq", step: { type: "mcq", question: "A strong negotiation opener combines:", options: ["Research, your value and a number", "An ultimatum with a resignation deadline", "An apology for even asking", "A vague hope of getting more money"], correct: 0, feedback: { correct: "Right. Evidence, your contribution, and a clear number.", incorrect: "Lead with market data, your value, and a specific figure, not ultimatums or apologies." } } },
...
const goalsSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mbx-gl-sp-mcq", step: { type: "mcq", question: "Which is the best-written financial goal?", options: [
      ...
      { variantId: "mbx-gl-sp-mcq2", step: { type: "mcq", question: "A complete financial goal includes:", options: ["An amount, a deadline and a reason", "Only a vague intention to do better", "Just one big ambitious dream", "Only a deadline and nothing else"], correct: 0, feedback: { correct: "Right. Amount + deadline + reason (and ideally a vehicle).", incorrect: "It needs a specific amount, a deadline and a reason to stick." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-gl-re-mcq", step: { type: "mcq", question: "The best way to make a big goal actionable is to:", options: ["Break it into a monthly amount", "Keep it as one big scary lump sum", "Wait for a windfall", "Hope that it happens"], correct: 0, feedback: { correct: "Right. A monthly number is something your budget can actually carry.", incorrect: "Convert it to a monthly contribution, then check it against your budget." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-gl-mu-mcq", step: { type: "mcq", question: "An emergency fund and retirement saving should be pursued:", options: ["At the same time", "One fully before the other starts", "Only after age 40", "Never together"], correct: 0, feedback: { correct: "Right. Different horizons run in parallel.", incorrect: "Run them together. Short-term and long-term goals are both essential now." } } },
      { variantId: "mbx-gl-mu-mcq2", step: { type: "mcq", question: "To avoid raiding one goal for another, you should:", options: ["A separate account per goal", "Mix everything in one account", "Only ever use cash", "Track nothing at all"], correct: 0, feedback: { correct: "Right. Separate accounts stop the holiday fund funding an impulse buy.", incorrect: "Separate accounts per goal prevent mixing and raiding." } } },
    ],
  },
  {
    ...
    conceptId: "financial-goals",
    variants: [
      { variantId: "mbx-gl-hz-mcq", step: { type: "mcq", question: "A house deposit in 5 years is best classed as a:", options: ["Medium-term, 2 to 7 years", "Short-term, up to 2 years away", "Long-term, more than 7 years", "Not really a proper goal at all"], correct: 0, feedback: { correct: "Right. 2–7 years is medium-term. Informs where you save it.", incorrect: "Five years is medium-term (2–7 years)." } } },
      ...
      { variantId: "mbx-gl-hz-sc", step: { type: "scenario", question: "Why does a goal's time horizon matter?", options: ["It guides where you keep it", "It doesn't really matter at all", "It sets your marginal tax rate", "It changes your monthly salary"], correct: 0, feedback: { correct: "Right. Short-term → safe/cash; long-term → growth assets.", incorrect: "Horizon drives the vehicle: near-term goals stay safe, long-term goals can hold growth assets." } } },
    ],
  },
];
...
const sideSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mbx-si-wy-mcq", step: { type: "mcq", question: "Why is relying on a single income stream risky?", options: ["Losing that job leaves no backup", "A single income is taxed more", "A single income stream is illegal", "A single income always pays less"], correct: 0, feedback: { correct: "Right. A second stream, even R2 000/month, buys time and cuts anxiety.", incorrect: "One stream means one point of failure. A second income is a safety buffer." } } },
      ...
      { variantId: "mbx-si-wy-mcq2", step: { type: "mcq", question: "For a qualified professional, the highest-margin, lowest-cost side income is usually:", options: ["Freelancing their own skill", "A physical retail storefront", "Flea-market reselling", "Renting out a vehicle"], correct: 0, feedback: { correct: "Right. Freelancing uses paid-for credentials at almost no cost.", incorrect: "Freelancing your existing skill has the highest margin and lowest startup cost." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-si-tx-mcq", step: { type: "mcq", question: "Earning more than R30 000 from non-salary sources means you must:", options: ["Register for provisional tax", "Pay nothing extra", "Close the side business", "Only declare it at retirement"], correct: 0, feedback: { correct: "Right. Provisional tax spreads the bill across the year.", incorrect: "Non-salary income over R30 000 triggers provisional tax (Aug and Feb)." } } },
      { variantId: "mbx-si-tx-mcq2", step: { type: "mcq", question: "Your taxable side-business profit is:", options: ["Income minus business expenses", "All the income, with no deductions", "Zero, since side income is exempt", "Only the cash portion you received"], correct: 0, feedback: { correct: "Right. Keep records of income and expenses; the difference is taxed.", incorrect: "It's income minus legitimate expenses. Keep records of both." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-si-in-mcq", step: { type: "mcq", question: "The most powerful thing to do with side income (if your salary covers your life) is to:", options: ["Invest it in a tax-free wrapper", "Spend it on upgrades", "Leave it in a low-interest account", "Lend it to friends"], correct: 0, feedback: { correct: "Right. Invested (and tax-free) it becomes serious long-term money.", incorrect: "Invest it, ideally in a TFSA, rather than absorbing it into spending." } } },
    ],
  },
  {
    ...
    conceptId: "side-income",
    variants: [
      { variantId: "mbx-si-rc-mcq", step: { type: "mcq", question: "A side-hustler should keep records of:", options: ["All income and business expenses", "Nothing, the work is informal", "Only the best earning months", "Only the cash income"], correct: 0, feedback: { correct: "Right. Records determine taxable profit and protect you in an audit.", incorrect: "Keep records of all income and expenses: they set your taxable profit." } } },
      ...
      { variantId: "mbx-si-rc-sc", step: { type: "scenario", question: "A freelancer never tracks income or expenses. Risk at tax time?", options: ["Can't prove profit, so may overpay tax", "No risk at all, SARS ignores small amounts", "An automatic refund paid straight from SARS", "Nothing at all ever happens to them at all"], correct: 0, feedback: { correct: "Right. No records means no defensible profit figure, costly at audit.", incorrect: "Without records you can't prove profit: risking overpayment or penalties." } } },
    ],
  },
];
...
const rateSlots: QuestionSlot[] = [
  ...
  },
  {
    ...
    conceptId: "interest-rates",
    variants: [
      { variantId: "mbx-rt-im-mcq", step: { type: "mcq", question: "On a R1 million bond over 20 years, a 1% rate rise costs roughly:", options: ["About R500 more per month", "About R50 more per month", "Nothing", "About R5 000 more per month"], correct: 0, feedback: { correct: "Right. ~R500/month, ~R6 000/year per 1% on a R1m bond.", incorrect: "About R500 more per month, roughly R6 000/year per 1% on R1m." } } },
      ...
      { variantId: "mbx-rt-im-sc", step: { type: "scenario", question: "The SARB hikes 0.5%. A homeowner with a variable bond should:", options: ["Review the budget and absorb it", "Panic and sell the house", "Refinance to a fixed rate immediately", "Do nothing, the bank will sort it out"], correct: 0, feedback: { correct: "Right. Extra capital lowers the balance future interest is charged on.", incorrect: "Review the budget and, if possible, pay extra capital to cushion future hikes." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-rt-fv-mcq2", step: { type: "mcq", question: "Choosing fixed vs variable should depend on:", options: ["Your rate view and risk tolerance", "Only the bank's own stated preference", "Always picking the lower headline rate", "Nothing at all, they are identical"], correct: 0, feedback: { correct: "Right. It's a trade-off of certainty vs potential savings.", incorrect: "Decide on your rate view and risk tolerance, not just the headline number." } } },
    ],
  },
  {
    ...
    conceptId: "interest-rates",
    variants: [
      { variantId: "mbx-rt-ec-mcq", step: { type: "mcq", question: "Paying extra capital into your bond:", options: ["Shrinks the balance", "Increases your interest rate", "Has no effect at all", "Is not allowed by banks"], correct: 0, feedback: { correct: "Right. A lower balance means less interest and a shorter term.", incorrect: "Extra capital cuts the balance, so future interest is charged on less." } } },
...
const talkSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      { variantId: "mbx-mt-sc-mcq", step: { type: "mcq", question: "Why does 'money silence' cost you?", options: ["It hides problems and fuels conflict", "It saves the household on tax", "It improves credit scores", "It has no real downside at all"], correct: 0, feedback: { correct: "Right. Not talking about money enables bad decisions and prevents learning.", incorrect: "Silence hides problems and blocks learning. That's the cost." } } },
      ...
      { variantId: "mbx-mt-sc-sc", step: { type: "scenario", question: "You're getting married and find your partner has R80 000 of hidden credit-card debt. Best approach?", options: ["Full disclosure of everything", "Deal with it after the wedding", "Quietly pay it off as a gift", "Leave it, money is private"], correct: 0, feedback: { correct: "Right. Transparency before the commitment, then a shared plan.", incorrect: "Full disclosure and a joint plan beats discovering hidden debt later." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-mt-pa-mcq", step: { type: "mcq", question: "Why have this conversation before a crisis?", options: ["So you can find the will and policies", "To take control of their money right now", "To reduce the tax that they pay", "There is no real reason to bother"], correct: 0, feedback: { correct: "Right. Knowing the locations avoids delays and lapsed claims later.", incorrect: "It's about knowing where critical documents are. Before you urgently need them." } } },
      { variantId: "mbx-mt-pa-sc", step: { type: "scenario", question: "A parent dies and nobody knows the insurer, will location, or bank. Likely result?", options: ["Delays, legal costs and lapsed claims", "SARS handles it smoothly", "Assets distribute automatically", "No consequences for the family"], correct: 0, feedback: { correct: "Right. Missing documents cause delays, costs and lost benefits.", incorrect: "It causes delays, legal cost and possibly lapsed claims, all avoidable." } } },
    ],
  },
  {
    ...
    conceptId: "money-conversations",
    variants: [
      { variantId: "mbx-mt-rg-mcq", step: { type: "mcq", question: "A 'family financial document register' should list:", options: ["Accounts, policies and will location", "Only the salary slips from your employer", "Your household and grocery shopping lists", "Nothing of any real importance"], correct: 0, feedback: { correct: "Right. The critical documents and where to find them, shared with someone trusted.", incorrect: "It lists accounts, policies, will location, beneficiaries and contacts." } } },
      ...
      { variantId: "mbx-mt-rg-sc", step: { type: "scenario", question: "What's a simple, high-value action most families skip?", options: ["Creating a shared document register", "Hiding all documents from everyone else", "Memorising all the account numbers only", "Nothing is really needed well in advance"], correct: 0, feedback: { correct: "Right. A 30-minute register prevents enormous stress later.", incorrect: "Create a shared document register. It's quick and prevents crisis-time chaos." } } },
    ],
  },
  {
    ...
    conceptId: "money-conversations",
    variants: [
      { variantId: "mbx-mt-tr-mcq", step: { type: "mcq", question: "Before a major financial commitment with a partner, you should:", options: ["Share your full financial picture", "Reveal only the good parts of it", "Keep everything secret for now", "Discuss it only if they think to ask"], correct: 0, feedback: { correct: "Right. Full transparency prevents hidden debt becoming a shared shock.", incorrect: "Share the complete picture. Hidden debt becomes a joint problem later." } } },
      ...
      { variantId: "mbx-mt-tr-sc", step: { type: "scenario", question: "A couple wants to avoid the top cause of marital conflict. They should:", options: ["Talk openly and plan together", "Never mention money at all", "Keep separate financial secrets", "Assume it will all work out"], correct: 0, feedback: { correct: "Right. Open money conversations pre-empt the most common conflict.", incorrect: "Talk about money openly and plan together. Silence is the danger." } } },
    ],
  },
];
...
const debtLifeSlots: QuestionSlot[] = [
  {
    ...
    variants: [
      ...
      { variantId: "mbx-dl-tc-mcq", step: { type: "mcq", question: "The 'illusion of affordability' is when people:", options: ["Fund a lifestyle on monthly repayments", "Save far too aggressively each month", "Pay cash for absolutely everything", "Avoid all non-essential spending entirely"], correct: 0, feedback: { correct: "Right. 'I can afford the repayment' hides the true, interest-laden cost.", incorrect: "It's funding an unaffordable lifestyle on monthly repayments: interest enriches the lender." } } },
  ...
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-dl-cs-sc", step: { type: "scenario", question: "Two people, same budget: one finances a new car, the other buys used and invests R5 000/month. Over 10 years?", options: ["The investor is far ahead", "They end up identical", "The car financier is ahead", "It is impossible to say"], correct: 0, feedback: { correct: "Right. The invested payment ≈R1m; the financed car is worth a fraction of its price.", incorrect: "The investor pulls far ahead, the same money compounds instead of depreciating." } } },
    ],
  },
  {
    ...
    variants: [
      ...
      { variantId: "mbx-dl-cc-mcq", step: { type: "mcq", question: "A credit card becomes a wealth destroyer when you:", options: ["Carry a balance at 20%", "Pay it off in full each month", "Use it only for planned buys", "Earn rewards and settle it"], correct: 0, feedback: { correct: "Right. Revolving a balance at high interest is the trap.", incorrect: "The trap is carrying a balance at 20%+. Paying in full is fine." } } },
      { variantId: "mbx-dl-cc-sc", step: { type: "scenario", question: "You use a credit card for convenience and rewards. The safe rule is:", options: ["Pay the full statement balance", "Pay only the minimum due", "Let it revolve for the rewards", "Max it out for points"], correct: 0, feedback: { correct: "Right. Full settlement each month = convenience and rewards at zero interest.", incorrect: "Pay the full balance monthly. Otherwise interest wipes out any rewards." } } },
    ],
  },
  {
    ...
    conceptId: "debt-payoff",
    variants: [
      { variantId: "mbx-dl-pr-sc", step: { type: "scenario", question: "Ntombi has R5 000 spare, a 24% clothing account (R8 000), a 10% student loan (R40 000), and no emergency fund. Best priority order?", options: ["Highest rate first, then buffer", "Student loan, clothing, buffer", "Emergency fund fully, then debt", "Split equally across all three"], correct: 0, feedback: { correct: "Right. Kill the 24% debt first, keep a small buffer, then the 10% loan.", incorrect: "Attack the 24% clothing account first, keep a mini buffer, then the 10% loan." } } },
