    ...
    variants: [
      {
        ...
        step: {
          ...
          options: [
            "Urgent threats like 'Your account closes in 24 hours",
    ...
    variants: [
      {
        ...
        step: {
          ...
          options: [
            "A criminal transfers your number to a SIM they control",
    ...
    variants: [
      {
        ...
        step: {
          ...
          options: [
            "Returns are 'guaranteed' every week regardless of markets",
    ...
    variants: [
      ...
      },
      {
        ...
        step: {
          ...
          options: [
            "Ask for its FSP number and verify it on the FSCA register",
      ...
      },
      {
        ...
        step: {
          ...
          options: [
            "Call the institution on its official switchboard that you look up yourself",
    ...
    variants: [
      ...
      },
      {
        ...
        step: {
          ...
          options: [
            "Shame is normal but it delays reporting. Acting fast matters more",
    ...
    variants: [
      ...
      },
      {
        ...
        step: {
          ...
          options: [
            "SAPS and the platform that hosted the listing",
    ...
    variants: [
      {
        ...
        step: {
          ...
          options: [
            "Save your bank's fraud line and SAPS in your phone now",
